...
/*****************************************************/
{
     ...
     * the dot operator: Actually for both HJWasm and Wasm the dot precedence
...
/******************************************/
{
     ...
     * HJWasm didn't do, unless -Zg was set.
     * Since v2.10, HJWasm behaves like Masm v6+: base and index registers
 ...
 */
{
    ...
    case T_OP_SQ_BRACKET:
        ...
        /* v2.03: make HJWasm reject syntax variants
         * "mov eax, DWORD [EBX]"
    ...
    case T_BINARY_OPERATOR:
        ...
        case T_SHL:
             ...
             * HJWasm intends to behave like Masm v8+.
