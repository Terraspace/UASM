...
void InitAutoMacros(void)
{
	...
	uint_32 macroLen[] = { 7, 6, 6, 6, 7, 7, 7, 8, 8, 10, 3, 7, 11, 19, 10, 2, 7, 2, 10, 11, 19, 5, 39, 39, 12, 5, 2, 3, 3, 26, 27, 2, 2, 11, 8, 8, 9, 22, 23, 23, 23, 23, 23, 5, 10, 10 }; // Count of individual lines of macro-body code.
	char *macCode[] = {
