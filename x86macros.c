...
void Addx86defs()
{
    ...
    if (ModuleInfo.langtype == LANG_REGCALL)
    {
        ...
        AddLineQueue("BPARAM5 TEXTEQU <R8B>");
        AddLineQueue("BPARAM6 TEXTEQU <R9B>");
        AddLineQueue("BPARAM7 TEXTEQU <R11B>");
        AddLineQueue("BPARAM8 TEXTEQU <R12B>");
        AddLineQueue("BPARAM9 TEXTEQU <R14B>");
        AddLineQueue("BPARAM10 TEXTEQU <R15B>");
    ...
    if (ModuleInfo.langtype == LANG_REGCALL)
    {
        ...
        AddLineQueue("BPARAM5 TEXTEQU <R8B>");
        AddLineQueue("BPARAM6 TEXTEQU <R9B>");
        AddLineQueue("BPARAM7 TEXTEQU <R10B>");
        AddLineQueue("BPARAM8 TEXTEQU <R11B>");
        AddLineQueue("BPARAM9 TEXTEQU <R12B>");
        AddLineQueue("BPARAM10 TEXTEQU <R14B>");
        AddLineQueue("BPARAM11 TEXTEQU <R15B>");
        AddLineQueue("BPARAM12 TEXTEQU <[SPL+13]>");
        AddLineQueue("BPARAM13 TEXTEQU <[SPL+14]>");
        AddLineQueue("BPARAM14 TEXTEQU <[SPL+15]>");
        AddLineQueue("BPARAM15 TEXTEQU <[SPL+16]>");
