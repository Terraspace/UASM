...
_BSS	ENDS
_DATA	SEGMENT
$SG11336 DB	'LstWrite( %u, %u ): enter [ pos=%u, GeneratedCode=%u, Ma'
	DB	'croLevel=%u ]', 0aH, 00H
	ORG $+1
$SG11341 DB	'LstWrite: Pass=%u, stored pos=%u', 0aH, 00H
	ORG $+2
$SG11345 DB	'%08X', 00H
	ORG $+3
$SG11358 DB	'%02X', 00H
...
$SG11368 DB	'%-25X', 00H
	ORG $+2
$SG11382 DB	0dH, 0aH, 00H
	ORG $+1
$SG11367 DB	'%-25I64X', 00H
	ORG $+3
$SG11374 DB	'%08X', 00H
	ORG $+3
$SG11378 DB	'%08X', 00H
...
$SG11388 DB	'%u', 00H
	ORG $+1
$SG11381 DB	'LstWrite: type=%u, writing CRLF', 0aH, 00H
	ORG $+3
$SG11398 DB	0dH, 0aH, 00H
	ORG $+1
$SG11390 DB	'LstWrite: writing (%u b) >%s< [%u/%u], new pos=%u', 0aH, 00H
	ORG $+1
$SG11399 DB	0dH, 0aH, 00H
	ORG $+1
$SG11396 DB	'LstWrite: writing (%u b) >%s%s<', 0aH, 00H
	ORG $+3
$SG11415 DB	0dH, 0aH, 00H
	ORG $+1
$SG11397 DB	'LstWrite: writing (%u b) >%s<', 0aH, 00H
	ORG $+1
$SG11400 DB	'LstWrite: additional line >%s<, new pos=%u', 0aH, 00H
$SG11435 DB	'%u', 00H
	ORG $+1
$SG11446 DB	'?', 00H
	ORG $+2
...
$SG11509 DB	'?', 00H
	ORG $+2
$SG11455 DB	'%s %s        %s', 00H
$SG11456 DB	' %5lu', 00H
	ORG $+2
$SG11508 DB	'GetMemtypeString: found mem_type=MT_PROC for sym=%s', 0aH
	DB	00H
	ORG $+3
$SG11515 DB	'?', 00H
	ORG $+2
$SG11543 DB	' ', 00H
	ORG $+2
$SG11548 DB	'%s %s        %8X (%u)', 00H
	ORG $+2
$SG11549 DB	'%s %s        %8X', 00H
	ORG $+3
$SG11556 DB	' ', 00H
	ORG $+2
$SG11550 DB	'%s %s        %8X', 00H
	ORG $+3
$SG11558 DB	'%s', 00H
	ORG $+1
...
$SG11586 DB	'?', 00H
	ORG $+2
$SG11582 DB	'%s %s      %6X  %7X', 00H
$SG11588 DB	'?', 00H
	ORG $+2
$SG11587 DB	'  %s %s      %6X  %7X  %016I64X %s', 00H
	ORG $+1
$SG11600 DB	' ', 00H
	ORG $+2
$SG11589 DB	'  %s %s      %6X  %7X  %08X %s', 00H
	ORG $+1
$SG11602 DB	' ', 00H
	ORG $+2
$SG11603 DB	' ', 00H
	ORG $+2
$SG11604 DB	'%s %s    %8u  %s', 00H
	ORG $+3
$SG11662 DB	' ', 00H
	ORG $+2
$SG11617 DB	'%s %s        ', 00H
	ORG $+2
$SG11620 DB	'32 Bit   %08X ', 00H
	ORG $+1
$SG11623 DB	'64 Bit   %08X ', 00H
	ORG $+1
$SG11624 DB	'16 Bit   %04X     ', 00H
	ORG $+1
$SG11733 DB	'%s', 00H
	ORG $+1
$SG11625 DB	'%-7s %-8s', 00H
	ORG $+2
$SG11627 DB	'''%s''', 00H
	ORG $+3
$SG11720 DB	'%0*X ', 00H
...
$SG11735 DB	'  ', 00H
	ORG $+1
$SG11647 DB	'%s %s        %s', 00H
$SG11718 DB	'%s %s        P %-6s %08X %-8s ', 00H
	ORG $+1
$SG11719 DB	'%s %s        P %-6s %04X     %-8s ', 00H
	ORG $+1
$SG11722 DB	'(F) ', 00H
	ORG $+3
$SG11725 DB	'%-9s', 00H
...
$SG11806 DB	'%s', 00H
	ORG $+1
$SG11808 DB	'%s %s        %s   %s', 00H
	ORG $+3
$SG11810 DB	'%s %s        %s  %s', 00H
$SG11184 DB	'Far', 00H
$SG11870 DB	'LstWriteCRef: calling qsort', 0aH, 00H
	ORG $+3
$SG11889 DB	'LstWriteCRef: log_symbol( %s )', 0aH, 00H
$SG11890 DB	'LstWriteCRef: %s suppressed', 0aH, 00H
	ORG $+3
$SG11891 DB	'LstWriteCRef: free sorted symbols', 0aH, 00H
	ORG $+1
$SG11171 DB	'Byte', 00H
	ORG $+3
$SG11172 DB	'Word', 00H
...
; 1003 :             LstPrintf( sym->weak ? "*%s " : "%s ", strings[LS_EXTERNAL] );
	...
	lea	rax, OFFSET FLAT:$SG11802
	mov	QWORD PTR tv218[rsp], rax
	jmp	SHORT $LN30@log_symbol
$LN29@log_symbol:
	lea	rax, OFFSET FLAT:$SG11803
	mov	QWORD PTR tv218[rsp], rax
$LN30@log_symbol:
	mov	eax, 8
