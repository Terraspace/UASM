...
_BSS	ENDS
_DATA	SEGMENT
$SG11341 DB	'LstWrite( %u, %u ): enter [ pos=%u, GeneratedCode=%u, Ma'
	DB	'croLevel=%u ]', 0aH, 00H
	ORG $+1
$SG11346 DB	'LstWrite: Pass=%u, stored pos=%u', 0aH, 00H
	ORG $+2
$SG11350 DB	'%08X', 00H
	ORG $+3
$SG11363 DB	'%02X', 00H
...
$SG11373 DB	'%-25X', 00H
	ORG $+2
$SG11387 DB	0dH, 0aH, 00H
	ORG $+1
$SG11372 DB	'%-25I64X', 00H
	ORG $+3
$SG11379 DB	'%08X', 00H
	ORG $+3
$SG11383 DB	'%08X', 00H
...
$SG11393 DB	'%u', 00H
	ORG $+1
$SG11386 DB	'LstWrite: type=%u, writing CRLF', 0aH, 00H
	ORG $+3
$SG11403 DB	0dH, 0aH, 00H
	ORG $+1
$SG11395 DB	'LstWrite: writing (%u b) >%s< [%u/%u], new pos=%u', 0aH, 00H
	ORG $+1
$SG11404 DB	0dH, 0aH, 00H
	ORG $+1
$SG11401 DB	'LstWrite: writing (%u b) >%s%s<', 0aH, 00H
	ORG $+3
$SG11420 DB	0dH, 0aH, 00H
	ORG $+1
$SG11402 DB	'LstWrite: writing (%u b) >%s<', 0aH, 00H
	ORG $+1
$SG11405 DB	'LstWrite: additional line >%s<, new pos=%u', 0aH, 00H
$SG11440 DB	'%u', 00H
	ORG $+1
$SG11451 DB	'?', 00H
	ORG $+2
...
$SG11461 DB	' %5lu', 00H
	ORG $+2
$SG11513 DB	'GetMemtypeString: found mem_type=MT_PROC for sym=%s', 0aH
	DB	00H
	ORG $+3
$SG11520 DB	'?', 00H
	ORG $+2
$SG11548 DB	' ', 00H
	ORG $+2
$SG11553 DB	'%s %s        %8X (%u)', 00H
	ORG $+2
$SG11554 DB	'%s %s        %8X', 00H
	ORG $+3
$SG11561 DB	' ', 00H
	ORG $+2
$SG11555 DB	'%s %s        %8X', 00H
	ORG $+3
$SG11563 DB	'%s', 00H
	ORG $+1
$SG11562 DB	'%s %s        %8X   ', 00H
$SG11565 DB	'[%u]', 00H
	ORG $+3
$SG11591 DB	'?', 00H
	ORG $+2
$SG11587 DB	'%s %s      %6X  %7X', 00H
$SG11593 DB	'?', 00H
	ORG $+2
$SG11592 DB	'  %s %s      %6X  %7X  %016I64X %s', 00H
	ORG $+1
$SG11605 DB	' ', 00H
	ORG $+2
$SG11594 DB	'  %s %s      %6X  %7X  %08X %s', 00H
	ORG $+1
$SG11607 DB	' ', 00H
	ORG $+2
$SG11608 DB	' ', 00H
	ORG $+2
$SG11609 DB	'%s %s    %8u  %s', 00H
	ORG $+3
$SG11667 DB	' ', 00H
	ORG $+2
$SG11622 DB	'%s %s        ', 00H
	ORG $+2
$SG11625 DB	'32 Bit   %08X ', 00H
	ORG $+1
$SG11628 DB	'64 Bit   %08X ', 00H
	ORG $+1
$SG11629 DB	'16 Bit   %04X     ', 00H
	ORG $+1
$SG11738 DB	'%s', 00H
	ORG $+1
$SG11630 DB	'%-7s %-8s', 00H
	ORG $+2
$SG11632 DB	'''%s''', 00H
	ORG $+3
$SG11725 DB	'%0*X ', 00H
...
$SG11740 DB	'  ', 00H
	ORG $+1
$SG11652 DB	'%s %s        %s', 00H
$SG11723 DB	'%s %s        P %-6s %08X %-8s ', 00H
	ORG $+1
$SG11724 DB	'%s %s        P %-6s %04X     %-8s ', 00H
	ORG $+1
$SG11727 DB	'(F) ', 00H
	ORG $+3
$SG11730 DB	'%-9s', 00H
...
$SG11798 DB	'%s ', 00H
$SG11737 DB	'(%.8s) ', 00H
$SG11748 DB	'  %s %s        %-17s %s', 00H
$SG11759 DB	'  %s %s        L %-6s %08X %s', 00H
	ORG $+2
$SG11760 DB	'  %s %s        L %-6s %04X     %s', 00H
	ORG $+2
$SG11762 DB	' (F)', 00H
	ORG $+3
$SG11778 DB	'%s[%u]', 00H
...
$SG11811 DB	'%s', 00H
	ORG $+1
$SG11813 DB	'%s %s        %s   %s', 00H
	ORG $+3
$SG11815 DB	'%s %s        %s  %s', 00H
$SG11189 DB	'Far', 00H
$SG11875 DB	'LstWriteCRef: calling qsort', 0aH, 00H
	ORG $+3
$SG11894 DB	'LstWriteCRef: log_symbol( %s )', 0aH, 00H
$SG11895 DB	'LstWriteCRef: %s suppressed', 0aH, 00H
	ORG $+3
$SG11896 DB	'LstWriteCRef: free sorted symbols', 0aH, 00H
	ORG $+1
$SG11176 DB	'Byte', 00H
	ORG $+3
$SG11177 DB	'Word', 00H
	ORG $+3
$SG11178 DB	'DWord', 00H
	ORG $+2
$SG11179 DB	'FWord', 00H
	ORG $+2
$SG11180 DB	'QWord', 00H
	ORG $+2
$SG11181 DB	'TByte', 00H
	ORG $+2
$SG11182 DB	'Para', 00H
	ORG $+3
$SG11186 DB	'Near16', 00H
	ORG $+1
$SG11201 DB	'Ptr', 00H
$SG11183 DB	'XmmWord', 00H
$SG11184 DB	'Page', 00H
	ORG $+3
$SG11185 DB	'Near', 00H
	ORG $+3
$SG11187 DB	'Near32', 00H
	ORG $+1
$SG11188 DB	'Near64', 00H
	ORG $+1
$SG11190 DB	'Far16', 00H
	ORG $+2
$SG11191 DB	'Far32', 00H
	ORG $+2
$SG11192 DB	'Far64', 00H
	ORG $+2
$SG11193 DB	'L Near', 00H
	ORG $+1
$SG11194 DB	'L Near16', 00H
	ORG $+3
$SG11197 DB	'L Far', 00H
	ORG $+2
$SG11204 DB	'Number', 00H
	ORG $+1
$SG11215 DB	'Abs', 00H
$SG11195 DB	'L Near32', 00H
	ORG $+3
$SG11206 DB	'Stack', 00H
	ORG $+2
$SG11207 DB	'Public', 00H
	ORG $+1
$SG11219 DB	'C', 00H
	ORG $+2
$SG11196 DB	'L Near64', 00H
	ORG $+3
$SG11208 DB	'Common', 00H
	ORG $+5
$SG11198 DB	'L Far16', 00H
$SG11199 DB	'L Far32', 00H
$SG11200 DB	'L Far64', 00H
$SG11202 DB	'Proc', 00H
	ORG $+3
$SG11203 DB	'Func', 00H
	ORG $+3
$SG11205 DB	'Private', 00H
$SG11209 DB	'External', 00H
	ORG $+7
$SG11210 DB	'Undefined', 00H
	ORG $+2
$SG11211 DB	'GROUP', 00H
	ORG $+2
$SG11212 DB	'No Seg', 00H
	ORG $+1
$SG11213 DB	'Text', 00H
	ORG $+3
$SG11214 DB	'Alias', 00H
	ORG $+2
$SG11216 DB	'COMM', 00H
	ORG $+3
$SG11217 DB	'VARARG', 00H
	ORG $+5
$SG11220 DB	'SYSCALL', 00H
$SG11221 DB	'STDCALL', 00H
$SG11222 DB	'PASCAL', 00H
	ORG $+1
$SG11223 DB	'FORTRAN', 00H
$SG11224 DB	'BASIC', 00H
	ORG $+2
$SG11225 DB	'FASTCALL', 00H
	ORG $+7
$SG11226 DB	'Macros:', 00H
$SG11227 DB	'                N a m e                 Type', 00H
	ORG $+3
$SG11228 DB	'Structures and Unions:', 00H
	ORG $+1
$SG11229 DB	'                N a m e                 Size/Ofs   Type', 00H
$SG11230 DB	'Records:', 00H
	ORG $+3
$SG11232 DB	'Types:', 00H
	ORG $+5
$SG11231 DB	'                N a m e                 Width   # fields'
	DB	0aH, '                                        Shift   Width   '
	DB	' Mask   Initial', 00H
	ORG $+7
$SG11233 DB	'                N a m e                 Size    Attr', 00H
	ORG $+3
$SG11234 DB	'Segments and Groups:', 00H
	ORG $+3
$SG11236 DB	'Procedures, parameters and locals:', 00H
	ORG $+5
$SG11235 DB	'                N a m e                 Size     Length '
	DB	'  Align   Combine Class', 00H
$SG11237 DB	'                N a m e                 Type     Value  '
	DB	'  Segment  Length', 00H
	ORG $+6
$SG11238 DB	'Symbols:', 00H
	ORG $+7
$SG11239 DB	'                N a m e                 Type       Value'
	DB	'     Attr', 00H
_DATA	ENDS
CONST	SEGMENT
cr	DW	00H
...
$pdata$LstWrite DD imagerel $LN75
	DD	imagerel $LN75+2836
...
CONST	SEGMENT
	ORG $+2
LstWrite$rtcName$0 DB 06cH
	DB	06cH
	DB	00H
	ORG $+5
LstWrite$rtcName$1 DB 05fH
	DB	05fH
	DB	024H
	DB	041H
	DB	06cH
	...
	DB	00H
	ORG $+2
LstWrite$rtcFrameData DD 02H
	DD	00H
	DQ	FLAT:LstWrite$rtcVarDesc
LstWriteCRef$rtcName$0 DB 071H
	DB	075H
	DB	065H
	DB	075H
	DB	065H
	...
	DB	00H
	ORG $+1
LstWrite$rtcVarDesc DD 0d8H
	DD	08H
	DQ	FLAT:LstWrite$rtcName$1
	DD	078H
	DD	030H
	DQ	FLAT:LstWrite$rtcName$0
	ORG $+96
LstWriteCRef$rtcVarDesc DD 060H
	DD	080H
	DQ	FLAT:LstWriteCRef$rtcName$0
	ORG $+48
LstWriteCRef$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:LstWriteCRef$rtcVarDesc
LstPrintf$rtcName$0 DB 061H
	DB	072H
	DB	067H
	DB	073H
	DB	00H
	ORG $+3
LstPrintf$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:LstPrintf$rtcVarDesc
log_segment$rtcName$0 DB 062H
	DB	075H
	DB	066H
	DB	066H
	DB	065H
	...
	DB	00H
	ORG $+1
LstPrintf$rtcVarDesc DD 028H
	DD	08H
	DQ	FLAT:LstPrintf$rtcName$0
	ORG $+48
log_segment$rtcVarDesc DD 028H
	DD	020H
	DQ	FLAT:log_segment$rtcName$0
	ORG $+48
log_segment$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:log_segment$rtcVarDesc
log_proc$rtcName$0 DB 062H
	DB	075H
	DB	066H
	DB	066H
	DB	065H
	...
	DB	00H
	ORG $+1
log_proc$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:log_proc$rtcVarDesc
	ORG $+8
log_proc$rtcVarDesc DD 088H
	DD	020H
	DQ	FLAT:log_proc$rtcName$0
CONST	ENDS
xdata	SEGMENT
$unwind$LstInit DD 021501H
	DD	070027206H
$unwind$LstWrite DD 035054219H
	DD	0116331bH
	DD	0700f0025H
	DD	0500eH
	DD	imagerel __GSHandlerCheck
	DD	0110H
$unwind$LstWriteSrcLine DD 021501H
	DD	070023206H
$unwind$LstWriteCRef DD 032a19H
	DD	0260109H
	DD	07002H
	DD	imagerel __GSHandlerCheck
	DD	0128H
$unwind$LstPrintf DD 022d01H
	DD	070157219H
$unwind$LstNL DD 021501H
	DD	070023206H
$unwind$LstSetPosition DD 021501H
	DD	070023206H
$unwind$log_macro DD 021e01H
	DD	07006920aH
$unwind$log_struct DD 022b01H
	DD	07010d214H
$unwind$log_record DD 032401H
	DD	014010dH
	DD	07006H
$unwind$log_typedef DD 021e01H
	DD	07006b20aH
$unwind$log_segment DD 033b19H
	DD	0140112H
	DD	0700bH
	DD	imagerel __GSHandlerCheck
	DD	090H
$unwind$log_group DD 022301H
	DD	0700b720fH
$unwind$log_proc DD 033619H
	DD	028010dH
	DD	07006H
	DD	imagerel __GSHandlerCheck
	DD	0130H
$unwind$get_seg_align DD 022301H
	DD	0700b520fH
$unwind$get_seg_combine DD 021e01H
	DD	07006120aH
$unwind$SimpleTypeString DD 021c01H
	DD	070051209H
$unwind$GetMemtypeString DD 022301H
	DD	0700b720fH
$unwind$GetLanguage DD 010601H
	DD	07006H
$unwind$get_proc_type DD 021e01H
	DD	07006520aH
$unwind$get_sym_seg_name DD 010601H
	DD	07006H
$unwind$log_symbol DD 021e01H
	DD	07006b20aH
$unwind$LstCaption DD 022201H
	DD	0700a320eH
$unwind$compare_syms DD 022301H
	DD	0700b320fH
$unwind$ListingDirective DD 022101H
	DD	0700a720eH
$unwind$ListMacroDirective DD 022101H
	DD	0700a320eH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
; 1003 :             LstPrintf( sym->weak ? "*%s " : "%s ", strings[LS_EXTERNAL] );
	...
	lea	rax, OFFSET FLAT:$SG11807
	mov	QWORD PTR tv218[rsp], rax
	jmp	SHORT $LN30@log_symbol
$LN29@log_symbol:
	lea	rax, OFFSET FLAT:$SG11808
	mov	QWORD PTR tv218[rsp], rax
$LN30@log_symbol:
	mov	eax, 8
...
$LN8@log_proc:
	...
	mov	rax, QWORD PTR [rax+112]
	mov	QWORD PTR f$[rsp], rax
	mov	eax, DWORD PTR curr$6[rsp]
	inc	eax
	mov	DWORD PTR curr$6[rsp], eax
$LN10@log_proc:
	mov	eax, DWORD PTR cnt$5[rsp]
	cmp	DWORD PTR curr$6[rsp], eax
...
; 903  :                 sprintf( buffer, "%s[%" I32_SPEC "u]", GetMemtypeString(&l->sym, NULL), l->sym.total_length );
	...
	lea	rcx, QWORD PTR buffer$7[rsp]
	call	sprintf
...
; 919  :             for ( l2 = l; l2; l2 = (struct dsym *)l2->sym.nextitem ) {
	...
	mov	rax, QWORD PTR l$[rsp]
	mov	QWORD PTR l2$8[rsp], rax
	jmp	SHORT $LN22@log_proc
$LN20@log_proc:
	mov	rax, QWORD PTR l2$8[rsp]
	mov	rax, QWORD PTR [rax]
	mov	QWORD PTR l2$8[rsp], rax
$LN22@log_proc:
	cmp	QWORD PTR l2$8[rsp], 0
	je	$LN21@log_proc
...
; 943  : }
	...
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:log_proc$rtcFrameData
...
; 717  :         pdots = (( i >= DOTSMAX ) ? "" : dots + i + 1);
	...
	cmp	DWORD PTR i$4[rsp], 32			; 00000020H
	jl	SHORT $LN8@log_segmen
	lea	rax, OFFSET FLAT:$SG11621
	mov	QWORD PTR tv73[rsp], rax
...
$LN9@log_segmen:
	mov	rax, QWORD PTR tv73[rsp]
	mov	QWORD PTR pdots$5[rsp], rax

; 718  :         LstPrintf( "%s %s        ", sym->name, pdots );

	mov	r8, QWORD PTR pdots$5[rsp]
	mov	rax, QWORD PTR sym$[rsp]
	mov	rdx, QWORD PTR [rax+8]
...
; 738  : }
	...
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:log_segment$rtcFrameData
	call	_RTC_CheckStackVars
	mov	rcx, QWORD PTR __$ArrayPad$[rsp]
	xor	rcx, rsp
	call	__security_check_cookie
...
; 397  : }
	...
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:LstPrintf$rtcFrameData
	call	_RTC_CheckStackVars
	add	rsp, 64					; 00000040H
	pop	rdi
	ret	0
...
; 1121 :                 for ( ps = cr[idx].capitems; *ps; ps++ ) {
	...
	lea	rcx, OFFSET FLAT:cr
	mov	rax, QWORD PTR [rcx+rax+8]
	mov	QWORD PTR ps$5[rsp], rax
	jmp	SHORT $LN14@LstWriteCR
$LN12@LstWriteCR:
	mov	rax, QWORD PTR ps$5[rsp]
	add	rax, 2
	mov	QWORD PTR ps$5[rsp], rax
$LN14@LstWriteCR:
	mov	rax, QWORD PTR ps$5[rsp]
...
; 1152 : }
	...
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:LstWriteCRef$rtcFrameData
	call	_RTC_CheckStackVars
	mov	rcx, QWORD PTR __$ArrayPad$[rsp]
	xor	rcx, rsp
	call	__security_check_cookie
...
; 195  :     switch ( type ) {
	...
	lea	rcx, OFFSET FLAT:__ImageBase
	mov	eax, DWORD PTR $LN74@LstWrite[rcx+rax*4]
	add	rax, rcx
	jmp	rax
$LN28@LstWrite:
...
; 282  :                 struct lstleft *next = myalloca( sizeof( struct lstleft ) );
	...
	mov	rax, QWORD PTR tv462[rbp]
	add	rax, 15
	cmp	rax, QWORD PTR tv462[rbp]
	ja	SHORT $LN73@LstWrite
...
$LN73@LstWrite:
	...
	add	QWORD PTR tv311[rbp], 32		; 00000020H
...
; 379  : }
	...
	lea	rdx, OFFSET FLAT:LstWrite$rtcFrameData
