...
_DATA	ENDS
_DATA	SEGMENT
$SG8594	DB	'atofloat(%s, 4): magnitude too large; FLT_MAX=%e FLT_MIN'
	DB	'=%e', 0aH, 00H
	ORG $+3
$SG8598	DB	'atofloat(%s, 8): magnitude too large', 0aH, 00H
_DATA	ENDS
PUBLIC	atofloat
