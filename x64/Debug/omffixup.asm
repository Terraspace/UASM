...
$SG10667 DB	'omffixup.c', 00H
	ORG $+5
$SG10668 DB	'omffixup.c', 00H
	ORG $+5
$SG10688 DB	'omf_write_modend(%p): fixup->frame_type/datum=%u/%u, EXT'
	DB	'ERNAL sym=%s', 0aH, 00H
	ORG $+2
$SG10690 DB	'NULL', 00H
	ORG $+3
$SG10691 DB	'OmfFixGenFixModend(%p): fixup->frame_type/datum=%u/%u sy'
	DB	'm->name=%s state=%X segm=%s', 0aH, 00H
	ORG $+3
$SG10692 DB	'omffixup.c', 00H
	ORG $+1
$SG10709 DB	'NULL', 00H
	ORG $+7
$SG10710 DB	'omf_fill_logref: sym=%s, state=%d, fixup->type=%u', 0aH, 00H
	ORG $+5
$SG10713 DB	'omf_fill_logref: sym is NULL, frame_type=%u', 0aH, 00H
	ORG $+3
$SG10717 DB	'omf_fill_logref: sym->state is SYM_UNDEFINED', 0aH, 00H
	ORG $+2
$SG10720 DB	'omf_fill_logref: sym->state is SYM_GRP', 0aH, 00H
$SG10725 DB	'omf_fill_logref: sym->state is SYM_SEG %s', 0aH, 00H
	ORG $+5
$SG10730 DB	'omf_fill_logref: sym->state is SYM_EXTERNAL, fixup->fram'
...
$SG10767 DB	'omffixup.c', 00H
	ORG $+5
$SG10768 DB	'omffixup.c', 00H
	ORG $+5
$SG10781 DB	'omffixup.c', 00H
_DATA	ENDS
PUBLIC	OmfFixGenFix
