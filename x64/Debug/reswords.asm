...
ResWordTable DW	00H
	...
	ORG $+4
	DQ	0000000000000000H
$SG14803 DB	'Set64Bit(%u): mode is to change', 0aH, 00H
	ORG $+3
$SG14915 DB	' %-8s', 00H
	ORG $+2
$SG14917 DB	0aH, 00H
	ORG $+2
$SG14842 DB	'ResWordsInit() enter', 0aH, 00H
	ORG $+2
$SG14844 DB	'ResWordsInit() exit', 0aH, 00H
	ORG $+3
$SG14860 DB	'ResWordsFini() enter', 0aH, 00H
	ORG $+2
$SG14861 DB	'ResWordsFini(): %s restored', 0aH, 00H
	ORG $+3
$SG14863 DB	'ResWordsInit(): %s reenabled', 0aH, 00H
	ORG $+2
$SG14880 DB	'SpecialTable', 0aH, 00H
	ORG $+2
$SG14887 DB	0aH, 'InstructionTable', 0aH, 00H
	ORG $+5
$SG14881 DB	'   # keyword             value   sflags  cpu val8 type f'
	DB	'lg len', 0aH, 00H
$SG14882 DB	'--------------------------------------------------------'
	DB	'------', 0aH, 00H
$SG14883 DB	'%4u %-16s %8X %8X %4X %4X  %2X  %2X %3u', 0aH, 00H
	ORG $+7
$SG14884 DB	'--------------------------------------------------------'
	DB	'------', 0aH, 00H
$SG14885 DB	0aH, 'items in InstrTable[]: %u', 0aH, 00H
	ORG $+4
$SG14886 DB	'items in optable_idx[]: %u, used by ResWordTable items %'
	DB	'u-%u', 0aH, 00H
	ORG $+2
$SG14888 DB	'   # keyword          cls cpu opc rmb b1 rmi pfx fst idx'
	DB	' flg len', 0aH, 00H
	ORG $+6
$SG14890 DB	'%4u %-16s %02X %4X  %02X  %02X %2u %X   %X   %u  %4u %3X'
	DB	' %3u', 0aH, 00H
	ORG $+2
$SG14913 DB	'%3u ', 00H
	ORG $+3
$SG14889 DB	'--------------------------------------------------------'
	DB	'--------', 0aH, 00H
	ORG $+6
$SG14909 DB	0aH, 'Reserved Word Hash Table', 0aH, 00H
	ORG $+5
$SG14910 DB	'Idx keywords', 0aH, 00H
	ORG $+2
$SG14924 DB	'[0=%u 1=%u %u %u %u %u %u %u]', 0aH, 00H
	ORG $+9
$SG14891 DB	'--------------------------------------------------------'
	DB	'--------', 0aH, 00H
	ORG $+6
...
$SG14921 DB	'---------------------------', 0aH, 00H
	ORG $+3
$SG14923 DB	'%u items in resw table, max items/line=%u ', 00H
_DATA	ENDS
CONST	SEGMENT
InstrTable DB	03H
	DB	00H
...
$pdata$get_hash DD imagerel get_hash
	DD	imagerel get_hash+139
	DD	imagerel $unwind$get_hash
$pdata$AddResWord DD imagerel AddResWord
	DD	imagerel AddResWord+324
	DD	imagerel $unwind$AddResWord
$pdata$RemoveResWord DD imagerel RemoveResWord
	DD	imagerel RemoveResWord+254
	DD	imagerel $unwind$RemoveResWord
$pdata$DumpInstrStats DD imagerel $LN17
	DD	imagerel $LN17+653
	DD	imagerel $unwind$DumpInstrStats
pdata	ENDS
xdata	SEGMENT
$unwind$FindResWord DD 010d01H
	DD	0620dH
$unwind$GetResWName DD 010d01H
	DD	0420dH
$unwind$IsKeywordDisabled DD 010d01H
	DD	0620dH
$unwind$DisableKeyword DD 010801H
	DD	04208H
$unwind$RenameKeyword DD 011201H
	DD	08212H
$unwind$Set64Bit DD 010801H
	DD	06208H
$unwind$ResWordsInit DD 010401H
	DD	06204H
$unwind$ResWordsFini DD 010401H
	DD	08204H
$unwind$DumpResWords DD 060c01H
	DD	019010cH
	DD	060047005H
	DD	030025003H
$unwind$get_hash DD 010d01H
	DD	0220dH
$unwind$AddResWord DD 010801H
	DD	08208H
$unwind$RemoveResWord DD 010801H
	DD	08208H
$unwind$DumpInstrStats DD 031b19H
	DD	0120109H
	DD	03002H
...
; 1333 :     printf("\nReserved Word Hash Table\n");
	...
	lea	rcx, OFFSET FLAT:$SG14909
	call	printf

; 1334 :     printf("Idx keywords\n");

	lea	rcx, OFFSET FLAT:$SG14910
	call	printf

; 1335 :     printf("---------------------------\n");

	lea	rcx, OFFSET FLAT:$SG14911
	call	printf
$LN8@DumpInstrS:
...
; 1215 :   ResWordTable[T_VPEXTRQ].flags |= RWF_X64;
	...
	mov	eax, 16
	imul	rax, rax, 1990				; 000007c6H
	lea	rcx, OFFSET FLAT:ResWordTable
	movzx	eax, BYTE PTR [rcx+rax+3]
	or	eax, 4
	mov	ecx, 16
	imul	rcx, rcx, 1990				; 000007c6H
	lea	rdx, OFFSET FLAT:ResWordTable
	mov	BYTE PTR [rdx+rcx+3], al
...
; 1216 :   ResWordTable[T_VPINSRQ].flags |= RWF_X64;
	...
	mov	eax, 16
	imul	rax, rax, 1991				; 000007c7H
	lea	rcx, OFFSET FLAT:ResWordTable
	movzx	eax, BYTE PTR [rcx+rax+3]
	or	eax, 4
	mov	ecx, 16
	imul	rcx, rcx, 1991				; 000007c7H
	lea	rdx, OFFSET FLAT:ResWordTable
	mov	BYTE PTR [rdx+rcx+3], al
