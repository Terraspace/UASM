...
CONST	ENDS
_DATA	SEGMENT
$SG12288 DB	'RELOC', 00H
	ORG $+2
$SG12289 DB	'.reloc', 00H
	ORG $+1
$SG12291 DB	'pe_set_values: searching segment types %Xh', 0aH, 00H
	ORG $+4
$SG12296 DB	'pe_set_values: section %s, start ofs=%Xh, size=%Xh, file'
	DB	' ofs=%Xh', 0aH, 00H
	ORG $+6
$SG12317 DB	'pe_set_values: warning: not start label found', 0aH, 00H
	ORG $+1
$SG12326 DB	'.rsrc', 00H
	ORG $+2
$SG12312 DB	'pe_set_values: object %.8s, VA=%X size=%X phys ofs/size='
	DB	'%Xh/%Xh', 0aH, 00H
	ORG $+3
$SG12328 DB	'.reloc', 00H
	ORG $+1
$SG12459 DB	' ', 00H
	ORG $+2
$SG12322 DB	'.idata$2', 00H
	ORG $+3
$SG12334 DB	'.pdata', 00H
	ORG $+1
$SG11951 DB	'HDR', 00H
$SG12323 DB	'.idata$3', 00H
	ORG $+3
$SG11901 DB	'.hdr$1', 00H
	ORG $+1
$SG11982 DB	'HDR', 00H
$SG12324 DB	'.idata$5', 00H
	ORG $+3
$SG12330 DB	'.tls', 00H
	ORG $+3
$SG11905 DB	'.hdr$', 00H
...
$SG11908 DB	'%s1 %r', 00H
	ORG $+5
$SG12394 DB	'bin_write_module: enter', 0aH, 00H
	ORG $+7
$SG12397 DB	'bin_write_module: MZ format, fixups=%u, sizehdr=%X', 0aH
	DB	00H
	ORG $+4
$SG12405 DB	'bin_write_module: .DOSSEG active', 0aH, 00H
	ORG $+6
$SG12406 DB	'bin_write_module: searching segment types %Xh', 0aH, 00H
	ORG $+1
$SG12410 DB	'bin_write_module: .ALPHA active', 0aH, 00H
	ORG $+7
$SG12408 DB	'bin_write_module: section %s, start ofs=%Xh, size=%Xh, f'
	DB	'ile ofs=%Xh', 0aH, 00H
	ORG $+3
$SG12411 DB	'NULL', 00H
	ORG $+3
$SG12412 DB	'bin_write_module(%s): start ofs=%Xh, size=%Xh, file ofs='
	DB	'%Xh, grp=%s', 0aH, 00H
	ORG $+3
$SG12413 DB	'bin_write_module: all CalcOffset() done', 0aH, 00H
	ORG $+7
$SG12421 DB	'bin_write_module: MZ, sizetotal=%Xh sizeheap=%Xh', 0aH, 00H
	ORG $+6
$SG12427 DB	'bin_write_module: MZ, stack=%Xh ofs=%Xh', 0aH, 00H
	ORG $+7
$SG12430 DB	'bin_write_module, start_label: offs=%Xh, seg.offs=%Xh, g'
	DB	'roup.offs=%Xh', 0aH, 00H
	ORG $+1
$SG12433 DB	'bin_write_module, ModuleInfo->start_label=%p', 0aH, 00H
	ORG $+2
$SG12434 DB	'bin_write_module: MZ, mzdata ofs_fixups=%Xh, alignment=%'
	DB	'Xh', 0aH, 00H
$SG11907 DB	'.hdr$', 00H
	ORG $+6
$SG12438 DB	'bin_write_module(%s): type=%u written=%X max=%X start=%X'
	DB	' fileofs=%X', 0aH, 00H
	ORG $+3
$SG12440 DB	'bin_write_module(%s): ABS segment not written', 0aH, 00H
	ORG $+1
$SG12452 DB	'bin_write_module(%s): nothing written', 0aH, 00H
	ORG $+1
$SG12447 DB	'bin_write_module(%s): segment not written, size=% Xh siz'
	DB	'emem=%X', 0aH, 00H
	ORG $+7
$SG12460 DB	'bin_write_module: exit', 0aH, 00H
$SG12450 DB	'bin_write_module(%s): write %Xh bytes at offset %Xh, ini'
	DB	'tialized bytes=%u, buffer=%p', 0aH, 00H
	ORG $+2
$SG12472 DB	'CheckExternal: error, %s weak=%u', 0aH, 00H
	ORG $+6
$SG11691 DB	'CalcOffset(%s): abs seg, offset=%Xh', 0aH, 00H
	ORG $+3
$SG11697 DB	'CalcOffset(%s): fileofs=%Xh, ofs=%Xh', 0aH, 00H
	ORG $+2
$SG11702 DB	'CalcOffset(%s): fileofs=%Xh, alignbytes=%u, ofs=%Xh, gro'
	DB	'up=%s, grp.ofs=%Xh', 0aH, 00H
	ORG $+4
$SG11714 DB	'CalcOffset(%s) exit: seg.fileofs=%Xh, seg.start_offset=%'
	DB	'Xh, endofs=%Xh fileofs=%Xh rva=%Xh', 0aH, 00H
	ORG $+4
$SG11736 DB	'GetSegRelocs( %p ) enter', 0aH, 00H
	ORG $+6
$SG11740 DB	'GetSegRelocs: found seg-related fixup at %s.%X', 0aH, 00H
$SG11746 DB	'GetSegRelocs: locofs=%X fileofs=%X segofs=%X grpofs=%X, '
	DB	'fixup value: %X %X', 0aH, 00H
	ORG $+4
$SG11747 DB	'GetSegRelocs()=%u', 0aH, 00H
	ORG $+5
$SG11772 DB	'GetImageSize(%s): fileofs=%Xh, max_offs=%Xh start=%Xh', 0aH
	DB	00H
	ORG $+1
$SG11774 DB	'GetImageSize(%u)=%Xh', 0aH, 00H
	ORG $+2
$SG11813 DB	'DoFixup(%s) enter, segment start ofs=%Xh', 0aH, 00H
	ORG $+6
$SG11825 DB	'DoFixup(%s): SECREL, primary seg=%s, start_offset=%X', 0aH
	DB	00H
	ORG $+2
$SG11819 DB	'DoFixup(%s, %04X, %s): variable, fixup->segment=%Xh fixu'
	DB	'p->offset=%Xh, fixup->sym->offset=%Xh', 0aH, 00H
	ORG $+1
$SG11821 DB	'DoFixup(%s): IMGREL, loc=%X value=%X seg.start=%X images'
	DB	'tart=%X', 0aH, 00H
	ORG $+7
$SG11826 DB	'DoFixup(%s): SECREL, loc=%X, value=%X', 0aH, 00H
	ORG $+1
$SG11828 DB	'DoFixup(%s): RELOFFx, loc=%X, sym=%s, [start_offset=%Xh,'
	DB	' fixup->offset=%Xh, fixup->sym->offset=%Xh', 0aH, 00H
$SG11910 DB	'.hdr$1', 00H
	ORG $+5
$SG11834 DB	'DoFixup(%s): loc=%04X, sym=%s, target->start_offset=%Xh,'
	DB	' fixup->offset=%Xh, fixup->sym->offset=%Xh', 0aH, 00H
$SG11921 DB	'.hdr$2', 00H
	ORG $+5
$SG11836 DB	'DoFixup(%s, %04X, %s): target segment=0, fixup->offset=%'
	DB	'Xh, fixup->sym->offset=%Xh', 0aH, 00H
	ORG $+4
$SG11838 DB	'DoFixup(%s, %04X): FIX_RELOFF8, value=%Xh, *target=%Xh', 0aH
	DB	00H
$SG11840 DB	'DoFixup(%s, %04X): FIX_RELOFF16, value=%Xh, *target=%Xh', 0aH
	DB	00H
	ORG $+7
$SG11843 DB	'DoFixup(%s, %04X): FIX_RELOFF32, value=%Xh, *target=%Xh', 0aH
	DB	00H
	ORG $+7
$SG11845 DB	'DoFixup(%s, %04X): FIX_OFF8, value=%Xh, *target=%Xh', 0aH
	DB	00H
	ORG $+3
$SG11849 DB	'DoFixup(%s, %04X): FIX_OFF32, value=%Xh, *target=%Xh', 0aH
	DB	00H
	ORG $+2
$SG11847 DB	'DoFixup(%s, %04X): FIX_OFF16, value=%Xh, target=%p *targ'
	DB	'et=%Xh', 0aH, 00H
$SG11851 DB	'DoFixup(%s, %04X): FIX_OFF32_IMGREL, value=%Xh, *target='
	DB	'%Xh', 0aH, 00H
	ORG $+3
$SG11853 DB	'DoFixup(%s, %04X): FIX_OFF32_SECREL, value=%Xh, *target='
	DB	'%Xh', 0aH, 00H
	ORG $+3
$SG11857 DB	'DoFixup(%s, %04X): FIX_OFF64, value=%Xh, *target=%I64Xh', 0aH
	DB	00H
	ORG $+7
$SG11859 DB	'DoFixup(%s, %04X): FIX_HIBYTE, value=%Xh, *target=%Xh', 0aH
	DB	00H
	ORG $+1
$SG11863 DB	'DoFixup(%s, %04X): FIX_SEG frame=%u, ', 00H
	ORG $+2
$SG11866 DB	'GROUP symbol, offset=%Xh codeptr=%p', 0aH, 00H
	ORG $+3
$SG11869 DB	'SEGMENT symbol, start_offset=%Xh', 0aH, 00H
	ORG $+6
$SG11872 DB	'group.offset=%Xh', 0aH, 00H
	ORG $+6
$SG11873 DB	'segment.offset=%Xh', 0aH, 00H
	ORG $+4
$SG11877 DB	'DoFixup(%s, %04X): FIX_PTR16, seg->start=%Xh', 0aH, 00H
	ORG $+2
$SG11883 DB	'DoFixup(%s, %04X): FIX_PTR32', 0aH, 00H
	ORG $+2
$SG11887 DB	'DoFixup(%s, %04X): invalid fixup %u', 0aH, 00H
	ORG $+3
$SG11899 DB	'pe_create_MZ_header enter', 0aH, 00H
	ORG $+5
$SG11903 DB	'pe_create_MZ_header: generate code', 0aH, 00H
	ORG $+4
$SG11904 DB	'%r DOTNAME', 00H
	ORG $+5
$SG11906 DB	'%s1 %r USE16 %r %s', 00H
	ORG $+5
$SG11924 DB	'set_file_flags(%s, %X): value=%X', 0aH, 00H
	ORG $+6
$SG11943 DB	'pe_create_PE_header enter', 0aH, 00H
	ORG $+1
$SG11948 DB	'.hdr$2', 00H
	ORG $+1
$SG11952 DB	'.hdr$2', 00H
	ORG $+5
$SG11954 DB	'@pe_file_flags', 00H
	ORG $+1
$SG11956 DB	'pe_create_PE_header: CreateVariable(@pe_file_flags)=%X ['
	DB	'value=%X]', 0aH, 00H
	ORG $+5
$SG11978 DB	'pe_create_section table enter', 0aH, 00H
	ORG $+1
$SG11980 DB	'.hdr$3', 00H
	ORG $+1
$SG11983 DB	'.hdr$3', 00H
	ORG $+1
$SG11991 DB	'CONST', 00H
	ORG $+2
$SG11995 DB	'.rsrc', 00H
	ORG $+2
$SG11998 DB	'.reloc', 00H
	ORG $+1
$SG11999 DB	'pe_create_section_table: searching type %u', 0aH, 00H
	ORG $+4
$SG12000 DB	'pe_create_section_table: section %s, type=%u, size=%X', 0aH
	DB	00H
	ORG $+1
$SG12003 DB	'pe_create_section_table: %s, type=%u is object %u', 0aH, 00H
	ORG $+5
$SG12005 DB	'pe_create_section_table: items in object table: %u', 0aH
	DB	00H
	ORG $+4
$SG12053 DB	'pe_emit_export_data enter', 0aH, 00H
	ORG $+5
$SG12056 DB	'%r DOTNAME', 00H
	ORG $+5
$SG12057 DB	'%s %r %r %s', 00H
$SG12066 DB	'DW %u', 00H
	ORG $+6
$SG12058 DB	'DD 0, 0%xh, 0, %r @%s_name, %u, %u, %u, %r @%s_func, %r '
	DB	'@%s_names, %r @%s_nameord', 00H
	ORG $+6
$SG12060 DB	'@%s_func %r DWORD', 00H
	ORG $+6
$SG12062 DB	'DD %r %s', 00H
	ORG $+7
$SG12063 DB	'@%s_names %r DWORD', 00H
	ORG $+5
$SG12064 DB	'DD %r @%s', 00H
	ORG $+6
$SG12065 DB	'@%s_nameord %r WORD', 00H
	ORG $+4
$SG12069 DB	'@%s_name DB ''%s'',0', 00H
	ORG $+5
$SG12071 DB	'@%s DB ''%s'',0', 00H
	ORG $+2
$SG12072 DB	'%s %r', 00H
	ORG $+2
$SG12097 DB	'ALIGN(8)', 00H
	ORG $+7
$SG12098 DB	'ALIGN(4)', 00H
	ORG $+7
$SG12099 DB	'pe_emit_import_data enter', 0aH, 00H
	ORG $+5
$SG12102 DB	'@LPPROC %r %r %r', 00H
	ORG $+7
$SG12103 DB	'%r DOTNAME', 00H
	ORG $+5
$SG12105 DB	'%s2 %r %r %s', 00H
	ORG $+3
$SG12106 DB	'DD %r @%s_ilt, 0, 0, %r @%s_name, %r @%s_iat', 00H
	ORG $+3
$SG12107 DB	'%s2 %r', 00H
	ORG $+1
$SG12108 DB	'%s4 %r %s %s', 00H
	ORG $+3
$SG12109 DB	'@%s_ilt label %r', 00H
	ORG $+7
$SG12111 DB	'@LPPROC %r @%s_name', 00H
	ORG $+4
$SG12112 DB	'@LPPROC 0', 00H
	ORG $+2
$SG12113 DB	'%s4 %r', 00H
	ORG $+5
$SG12114 DB	'%s5 %r %s %s', 00H
	ORG $+3
$SG12115 DB	'@%s_iat label %r', 00H
	ORG $+7
$SG12117 DB	'%s%s @LPPROC %r @%s_name', 00H
	ORG $+7
$SG12118 DB	'@LPPROC 0', 00H
	ORG $+2
$SG12119 DB	'%s5 %r', 00H
	ORG $+5
$SG12120 DB	'%s6 %r %r %s', 00H
	ORG $+3
$SG12122 DB	'@%s_name dw 0', 00H
	ORG $+2
$SG12123 DB	'db ''%s'',0', 00H
	ORG $+2
$SG12124 DB	'even', 00H
	ORG $+7
$SG12127 DB	'@%s_%s_name db ''%s.%s'',0', 00H
	ORG $+7
$SG12128 DB	'@%s_name db ''%s'',0', 00H
	ORG $+1
$SG12129 DB	'even', 00H
	ORG $+3
$SG12130 DB	'%s6 %r', 00H
	ORG $+5
$SG12132 DB	'%s3 %r %r %s', 00H
	ORG $+3
$SG12133 DB	'DD 0, 0, 0, 0, 0', 00H
	ORG $+3
$SG12134 DB	'%s3 %r', 00H
	ORG $+1
$SG12158 DB	'CONST', 00H
	ORG $+2
$SG12281 DB	'.hdr$1', 00H
	ORG $+1
$SG12282 DB	'.hdr$2', 00H
	ORG $+1
$SG12283 DB	'.hdr$3', 00H
	ORG $+5
$SG12287 DB	'pe_set_values: .reloc section required', 0aH, 00H
_DATA	ENDS
PUBLIC	bin_init
...
; 996  :     char *align = ( ModuleInfo.defOfssize == USE64 ? "ALIGN(8)" : "ALIGN(4)" );
	...
	lea	rax, OFFSET FLAT:$SG12097
	mov	QWORD PTR tv69[rsp], rax
	jmp	SHORT $LN27@pe_emit_im
$LN26@pe_emit_im:
	lea	rax, OFFSET FLAT:$SG12098
	mov	QWORD PTR tv69[rsp], rax
$LN27@pe_emit_im:
