...
CONST	ENDS
_DATA	SEGMENT
$SG11283 DB	'%3u: %s', 0aH, 00H
	ORG $+7
$SG11287 DB	'debugging output on', 0aH, 00H
	ORG $+3
$SG11291 DB	'FASTPASS disabled', 0aH, 00H
	ORG $+1
$SG11358 DB	'?', 00H
	ORG $+2
$SG11295 DB	'backpatching disabled', 0aH, 00H
	ORG $+1
$SG11359 DB	'af', 00H
	ORG $+1
$SG11360 DB	'bin', 00H
...
$SG11422 DB	'sp', 00H
	ORG $+1
$SG11421 DB	'safeseh', 00H
$SG11423 DB	'WX', 00H
	ORG $+1
$SG11424 DB	'W=#', 00H
$SG11425 DB	'win64', 00H
	ORG $+2
$SG11426 DB	'w', 00H
	ORG $+2
$SG11427 DB	'X', 00H
...
$SG11499 DB	'rb', 00H
	ORG $+1
$SG11469 DB	'GetNameToken( %s, %u, ''%c'' ) enter, rspidx=%u', 0aH, 00H
	ORG $+1
$SG11498 DB	'ReadParamFile(%s) enter', 0aH, 00H
	ORG $+3
$SG11180 DB	'Zi', 00H
	ORG $+1
$SG11551 DB	'ProcessOption(%s)', 0aH, 00H
	ORG $+1
$SG11189 DB	'Zp', 00H
	ORG $+1
$SG11568 DB	'ProcessOption: unknown option specifier: %s', 0aH, 00H
	ORG $+3
$SG11569 DB	'cmdline.c', 00H
	ORG $+2
$SG11611 DB	'NULL', 00H
	ORG $+3
$SG11260 DB	'W', 00H
	ORG $+2
$SG11612 DB	'ParseCmdLine: file=>%s< rest=>%s<', 0aH, 00H
	ORG $+5
$SG11635 DB	'CmdLineFini enter', 0aH, 00H
	ORG $+5
$SG11638 DB	'CmdLineFini exit', 0aH, 00H
	ORG $+6
Options	DB	00H
	DB	00H
	DB	00H
	...
	DB	00H
	ORG $+3
$SG11127 DB	'queue_item(%u, %s) enter', 0aH, 00H
	ORG $+6
$SG11140 DB	'get_fname( type=%u, >%s< ) enter', 0aH, 00H
	ORG $+6
$SG11142 DB	'get_fname(%u, >%s< ) name is empty or a directory', 0aH, 00H
	ORG $+5
$SG11146 DB	'get_fname: default drive+dir used: %s', 0aH, 00H
_DATA	ENDS
