...
$SG10394 DB	'AddLineQueue(%p): #=%u >%s<', 0aH, 00H
	ORG $+3
$SG10466 DB	'RunLineQueue() enter', 0aH, 00H
	ORG $+10
$SG10469 DB	'!!!!! Warning: End directive found in generated-code par'
	DB	'ser loop!', 0aH, 00H
	ORG $+5
$SG10470 DB	'RunLineQueue() exit', 0aH, 00H
_DATA	ENDS
PUBLIC	GetLqLine
