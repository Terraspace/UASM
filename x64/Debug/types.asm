...
; 1242 :             f->sym.mem_type = MT_BITS;
	...
	mov	rax, QWORD PTR f$[rsp]
	mov	DWORD PTR [rax+44], 193			; 000000c1H
...
; 1025 :         sym->mem_type = MT_PROC;
	...
	mov	rax, QWORD PTR sym$[rsp]
	mov	DWORD PTR [rax+44], 128			; 00000080H
