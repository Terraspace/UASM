...
$SG11290 DB	'NULL', 00H
	ORG $+3
$SG11291 DB	'<anonymous>', 00H
$SG11341 DB	'union', 00H
	ORG $+6
$SG11292 DB	'CreateStructField(%s): name=%s, curr ofs=%u, vartype=%s,'
	DB	' size=%u', 0aH, 00H
	ORG $+6
$SG11305 DB	'CreateStructField(%s): initializer=>%s<', 0aH, 00H
	ORG $+7
$SG11306 DB	'CreateStructField(%s): no initializer<', 0aH, 00H
$SG11315 DB	'CreateStructField(%s): align=%u, size=%u, ofs=%u', 0aH, 00H
	ORG $+6
$SG11322 DB	'CreateStructField(%s): max_mbr_size set to %u', 0aH, 00H
	ORG $+1
$SG11342 DB	'struct', 00H
	ORG $+1
$SG11324 DB	'CreateStructField(%s): Masm51 compat on, lookup %s in gl'
	DB	'obal symbol table', 0aH, 00H
	ORG $+5
$SG11343 DB	'UpdateStructSize(%s.%s): %s, curr mbr size=%u curr struc'
	DB	'/union size=%u', 0aH, 00H
$SG11407 DB	'GetQualifiedType: memtype=%X, symtype set by target_type'
	DB	0aH, 00H
	ORG $+6
$SG11416 DB	'GetQualifiedType: invalid type : %s', 0aH, 00H
	ORG $+3
$SG11424 DB	'GetQualifiedType: memtype=%X, symtype set by target_type'
	DB	0aH, 00H
	ORG $+2
$SG11429 DB	'NULL', 00H
	ORG $+7
$SG11459 DB	'TypedefDirective(%d) enter', 0aH, 00H
$SG11116 DB	'NULL', 00H
	ORG $+7
$SG11430 DB	'GetQualifiedType: i=%u, memtype=%Xh, ptr=%u, far=%u, ofs'
	DB	'size=%d, arbtype=%s:%X', 0aH, 00H
$SG11472 DB	'TypedefDirective PROTO, created new unnamed prototype %p'
	DB	0aH, 00H
	ORG $+6
$SG11475 DB	'TypedefDirective PROTO, call ParseProc(sym=%p i=%d, 0)', 0aH
	DB	00H
$SG11477 DB	'TypedefDirective PROTO, ParseProc() returned status ok', 0aH
	DB	00H
$SG11479 DB	'TypedefDirective(%s) ok, mem_type=%Xh, ofssize=%u', 0aH, 00H
	ORG $+5
$SG11497 DB	'TypedefDirective: unexpected token %u, idx=%u', 0aH, 00H
	ORG $+1
$SG11585 DB	'RecordDirective(%s) exit, no error', 0aH, 00H
	ORG $+4
$SG11491 DB	'TypedefDirective: old-new memtype=%X-%X type=%X(%s)-%X(%'
	DB	's) far=%u-%u ind=%u-%u ofss=%d-%d pmt=%X-%X', 0aH, 00H
	ORG $+3
$SG11595 DB	'DeleteType(%s) enter, typekind=%u, memtype=%Xh', 0aH, 00H
$SG11064 DB	'AreStructsEqual: fields don''t match', 0aH, 00H
	ORG $+3
$SG11494 DB	'TypedefDirective(%s) ok, mem_type=MT_TYPE, size=%u, type'
	DB	'=%p type.memtype=%X', 0aH, 00H
	ORG $+3
$SG11495 DB	'TypedefDirective(%s) ok, mem_type=%Xh, size=%u, indirect'
	DB	'ion=%u target=%p', 0aH, 00H
	ORG $+6
$SG11542 DB	'RecordDirective(%d) enter', 0aH, 00H
	ORG $+5
$SG11049 DB	'SearchNameInStruct: ''%s'' found in struct %s', 0aH, 00H
	ORG $+3
$SG11061 DB	'AreStructsEqual(%s) enter', 0aH, 00H
	ORG $+5
$SG11068 DB	'AreStructsEqual: type name of field changed', 0aH, 00H
	ORG $+3
$SG11070 DB	'AreStructsEqual: offset of field %s changed: %u - %u', 0aH
	DB	00H
	ORG $+2
$SG11072 DB	'AreStructsEqual: total_size of field changed', 0aH, 00H
	ORG $+2
$SG11117 DB	'StructDirective(%s) enter, i=%u, CurrStruct=%s', 0aH, 00H
$SG11121 DB	'StructDirective(%s): error: either currstruct or i must '
	DB	'be 0', 0aH, 00H
	ORG $+2
$SG11139 DB	'StructDirective(%s) alignment=%u', 0aH, 00H
	ORG $+6
$SG11143 DB	'StructDirective(%s): error: unexpected token %u >%s<', 0aH
	DB	00H
	ORG $+2
$SG11148 DB	'StructDirective: SymSearch (%s)=%X (curr struct=%X)', 0aH
	DB	00H
	ORG $+3
$SG11149 DB	'StructDirective(%s): SearchNameInStruc()=%X', 0aH, 00H
	ORG $+3
$SG11155 DB	'types.c', 00H
$SG11156 DB	'types.c', 00H
$SG11194 DB	'EndstructDirective(%s), ofs=%u, struct size=%u, max_mbr='
	DB	'%u, alignment=%u', 0aH, 00H
	ORG $+6
$SG11205 DB	'EndstructDirective: names don''t match, i=%u, name=%s - '
	DB	'%s', 0aH, 00H
	ORG $+5
$SG11211 DB	'EndstructDirective:, struct size after final alignment=%'
	DB	'u', 0aH, 00H
	ORG $+5
$SG11225 DB	'EndstructDirective: delete the redefinition of %s', 0aH, 00H
	ORG $+5
$SG11227 DB	'EndstructDirective: new size of restored structure=%u', 0aH
	DB	00H
_DATA	ENDS
