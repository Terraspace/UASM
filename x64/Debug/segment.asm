...
_DATA	ENDS
_DATA	SEGMENT
$SG11288 DB	'READONLY', 00H
	ORG $+3
$SG11289 DB	'BYTE', 00H
	ORG $+3
$SG11290 DB	'WORD', 00H
	ORG $+3
$SG11291 DB	'DWORD', 00H
	ORG $+2
$SG11292 DB	'PARA', 00H
	ORG $+3
$SG11293 DB	'PAGE', 00H
	ORG $+3
$SG11294 DB	'ALIGN', 00H
	ORG $+2
$SG11296 DB	'PUBLIC', 00H
	ORG $+1
$SG11300 DB	'AT', 00H
	ORG $+1
$SG11295 DB	'PRIVATE', 00H
$SG11297 DB	'STACK', 00H
	ORG $+2
$SG11298 DB	'COMMON', 00H
	ORG $+1
$SG11299 DB	'MEMORY', 00H
	ORG $+1
$SG11301 DB	'COMDAT', 00H
	ORG $+1
$SG11302 DB	'USE16', 00H
	ORG $+2
$SG11303 DB	'USE32', 00H
	ORG $+2
$SG11304 DB	'USE64', 00H
	ORG $+2
$SG11305 DB	'FLAT', 00H
	ORG $+3
$SG11306 DB	'INFO', 00H
	ORG $+3
$SG11307 DB	'DISCARD', 00H
$SG11308 DB	'NOCACHE', 00H
$SG11309 DB	'NOPAGE', 00H
	ORG $+1
$SG11310 DB	'SHARED', 00H
	ORG $+1
$SG11311 DB	'EXECUTE', 00H
$SG11312 DB	'READ', 00H
	ORG $+3
$SG11313 DB	'WRITE', 00H
	ORG $+2
$SG11314 DB	'ALIAS', 00H
	ORG $+2
$SG11350 DB	'UpdateCurPC: curr value=%Xh', 0aH, 00H
	ORG $+3
$SG11363 DB	'FreeLnameQueue enter', 0aH, 00H
	ORG $+2
$SG11365 DB	'FreeLnameQueue exit', 0aH, 00H
	ORG $+3
$SG11373 DB	'NULL', 00H
	ORG $+3
$SG11374 DB	'UpdateCurrSegVars(%s)', 0aH, 00H
	ORG $+1
$SG11444 DB	'DeleteGroup(%s): free seg_item=%p', 0aH, 00H
	ORG $+1
$SG11592 DB	'BSS', 00H
$SG11445 DB	'DeleteGroup(%s): extension %p will be freed', 0aH, 00H
	ORG $+3
$SG11488 DB	'GrpDir: segment >%s< is in group >%s< already', 0aH, 00H
	ORG $+1
$SG11513 DB	'SetOfssize, error: CurrSeg=%s, ModuleInfo.Ofssize=%u, cu'
...
$SG11769 DB	'(', 00H
	ORG $+2
$SG11514 DB	'SetOfssize: ModuleInfo.Ofssize=%u', 0aH, 00H
	ORG $+1
$SG11772 DB	')', 00H
	ORG $+2
$SG11520 DB	'CloseSeg(%s) enter', 0aH, 00H
$SG11786 DB	'(', 00H
	ORG $+2
$SG11524 DB	'CloseSeg(%s): nesting error, CurrSeg=%s', 0aH, 00H
	ORG $+3
$SG11580 DB	'CONST', 00H
	ORG $+2
$SG11792 DB	'1-6', 00H
$SG11525 DB	'CloseSeg(%s): current ofs=%X', 0aH, 00H
	ORG $+2
$SG11532 DB	'FLAT', 00H
	ORG $+3
$SG11533 DB	'DefineFlatGroup(): Ofssize=%u', 0aH, 00H
	ORG $+1
$SG11582 DB	'DBTYP', 00H
	ORG $+2
$SG11584 DB	'DBSYM', 00H
	ORG $+2
$SG11587 DB	'CODE', 00H
	ORG $+3
$SG11589 DB	'DATA', 00H
	ORG $+3
$SG11674 DB	'SetCurrSeg(%s) sym=%p', 0aH, 00H
	ORG $+1
$SG11744 DB	'SegmentDir(%s) enter: ModuleInfo.Ofssize=%u, num_seg=%u', 0aH
	DB	00H
	ORG $+3
$SG11800 DB	')', 00H
	ORG $+2
$SG11754 DB	'SegmentDir(%s): symbol redefinition', 0aH, 00H
	ORG $+3
$SG11755 DB	'SegmentDir(%s): i=%u, string=%s token=%X', 0aH, 00H
	ORG $+2
$SG11816 DB	'(', 00H
	ORG $+2
$SG11758 DB	'SegmentDir(%s): class found: %s', 0aH, 00H
	ORG $+3
$SG11820 DB	')', 00H
	ORG $+2
$SG11764 DB	'SegmentDir(%s): align attribute found', 0aH, 00H
	ORG $+1
$SG11766 DB	'SegmentDir(%s): ALIGN() found', 0aH, 00H
	ORG $+1
$SG11776 DB	'SegmentDir(%s): combine attribute found', 0aH, 00H
	ORG $+7
$SG11778 DB	'SegmentDir(%s): AT found', 0aH, 00H
	ORG $+6
$SG11783 DB	'SegmentDir(%s): COMDAT found', 0aH, 00H
	ORG $+2
$SG11806 DB	'SegmentDir(%s): characteristics found', 0aH, 00H
	ORG $+1
$SG11811 DB	'NULL', 00H
	ORG $+3
$SG11812 DB	'SegmentDir(%s): ALIAS found, curr value=%s', 0aH, 00H
	ORG $+4
$SG11825 DB	'SegmentDir(%s): ALIAS argument=>%s<', 0aH, 00H
	ORG $+3
$SG11827 DB	'segment.c', 00H
	ORG $+6
$SG11871 DB	'segment.c', 00H
	ORG $+6
$SG11883 DB	'SegmentFini() enter', 0aH, 00H
	ORG $+3
$SG11885 DB	'SegmentFini() exit', 0aH, 00H
	ORG $+4
$SG11903 DB	'SegmentInit(%u) enter', 0aH, 00H
	ORG $+1
$SG11909 DB	'SegmentInit(%u), %s: max_ofs=%X, alloc_size=%Xh', 0aH, 00H
	ORG $+7
$SG11911 DB	'SegmentInit(%u): total buffer size=%X, start=%p', 0aH, 00H
	ORG $+7
$SG11916 DB	'SegmentInit(%u), %s: buffer=%p', 0aH, 00H
$SG11917 DB	'SegmentInit(%u), %s: size=%X buffer=%p', 0aH, 00H
$SG11927 DB	'SegmentSaveState: saved_segStack=%X', 0aH, 00H
_DATA	ENDS
CONST	SEGMENT
SegAttrToken DQ	FLAT:$SG11288
	DQ	FLAT:$SG11289
	DQ	FLAT:$SG11290
	DQ	FLAT:$SG11291
	DQ	FLAT:$SG11292
...
$pdata$GetSegIdx DD imagerel $LN4
	DD	imagerel $LN4+32
	DD	imagerel $unwind$GetSegIdx
$pdata$SegmentInit DD imagerel $LN23
	DD	imagerel $LN23+955
...
$pdata$SetCurrSeg DD imagerel SetCurrSeg
	DD	imagerel SetCurrSeg+261
	DD	imagerel $unwind$SetCurrSeg
$pdata$UnlinkSeg DD imagerel UnlinkSeg
	DD	imagerel UnlinkSeg+209
	DD	imagerel $unwind$UnlinkSeg
$pdata$SegmentDir DD imagerel $LN101
	DD	imagerel $LN101+4768
...
CONST	SEGMENT
	ORG $+2
TypeFromClassName$rtcName$0 DB 075H
	DB	06eH
	DB	061H
	DB	06dH
	DB	065H
	DB	00H
	ORG $+2
TypeFromClassName$rtcVarDesc DD 040H
	DD	0f8H
	DQ	FLAT:TypeFromClassName$rtcName$0
	ORG $+48
TypeFromClassName$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:TypeFromClassName$rtcVarDesc
SegmentDir$rtcName$0 DB 06fH
	DB	06cH
	DB	064H
	DB	061H
	DB	06cH
...
SegmentDir$rtcName$2 DB 06fH
	...
	DB	00H
	ORG $+5
SegmentDir$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:SegmentDir$rtcVarDesc
	ORG $+8
SegmentDir$rtcVarDesc DD 090H
	DD	068H
	DQ	FLAT:SegmentDir$rtcName$3
CONST	ENDS
xdata	SEGMENT
$unwind$SetSymSegOfs DD 021e01H
	DD	07006320aH
$unwind$GetSymOfssize DD 021e01H
	DD	07006120aH
$unwind$GetCurrOffset DD 021501H
	DD	070021206H
$unwind$CreateIntSegment DD 022d01H
	DD	070155219H
$unwind$GetSegIdx DD 010601H
	DD	07006H
$unwind$SegmentInit DD 021c01H
	DD	070059209H
$unwind$SegmentFini DD 021501H
	DD	070023206H
$unwind$GetGroup DD 021e01H
	DD	07006120aH
$unwind$GetCurrSegAlign DD 021501H
	DD	070021206H
$unwind$SetOfssize DD 021501H
	DD	070027206H
$unwind$TypeFromClassName DD 033b19H
	DD	02c0112H
	DD	0700bH
	DD	imagerel __GSHandlerCheck
	DD	0158H
$unwind$DefineFlatGroup DD 021501H
	DD	070023206H
$unwind$SegmentModuleExit DD 021501H
	DD	070023206H
$unwind$DeleteGroup DD 021e01H
	DD	07006520aH
$unwind$SegmentSaveState DD 021501H
	DD	070023206H
$unwind$FindToken DD 022801H
	DD	070105214H
$unwind$UpdateCurPC DD 022301H
	DD	0700b520fH
$unwind$AddLnameItem DD 021e01H
	DD	07006320aH
$unwind$FreeLnameQueue DD 021501H
	DD	070025206H
$unwind$UpdateCurrSegVars DD 021501H
	DD	070025206H
$unwind$push_seg DD 021e01H
	DD	07006320aH
$unwind$pop_seg DD 021501H
	DD	070023206H
$unwind$CreateGroup DD 021e01H
	DD	07006520aH
$unwind$CreateSegment DD 022801H
	DD	070105214H
$unwind$GrpDir DD 022101H
	DD	0700a920eH
$unwind$UpdateWordSize DD 010b01H
	DD	0700bH
$unwind$CloseSeg DD 021e01H
	DD	07006520aH
$unwind$FindClass DD 022201H
	DD	0700a520eH
$unwind$CreateClassLname DD 021e01H
	DD	07006520aH
$unwind$SetSegmentClass DD 022301H
	DD	0700b520fH
$unwind$EndsDir DD 022101H
	DD	0700a320eH
$unwind$SetCurrSeg DD 022101H
	DD	0700a520eH
$unwind$UnlinkSeg DD 021e01H
	DD	07006120aH
$unwind$SegmentDir DD 032701H
	DD	02a0111H
	DD	0700aH
$unwind$SortSegments DD 021c01H
	DD	070059209H
xdata	ENDS
...
; 1066 :         switch ( type->init ) {
	...
	movzx	eax, BYTE PTR $LN99@SegmentDir[rcx+rax]
	mov	eax, DWORD PTR $LN100@SegmentDir[rcx+rax*4]
	add	rax, rcx
	jmp	rax
$LN26@SegmentDir:
...
; 1263 :                 memcpy( dir->e.seginfo->aliasname, tokenarray[temp].string_ptr+1, tokenarray[temp].stringlen );
	...
	mov	rdx, QWORD PTR dir$[rsp]
	mov	rdx, QWORD PTR [rdx+96]
	mov	QWORD PTR tv746[rsp], rdx
	mov	r8d, eax
	mov	rdx, rcx
	mov	rax, QWORD PTR tv746[rsp]
	mov	rcx, QWORD PTR [rax+96]
	call	memcpy
...
; 1282 :         res = TypeFromClassName( dir, dir->e.seginfo->clsym );
	...
	mov	DWORD PTR res$8[rsp], eax

; 1283 :         if( res != SEGTYPE_UNDEF ) {

	cmp	DWORD PTR res$8[rsp], 0
...
; 1300 :         if ( oldalign    != dir->e.seginfo->alignment )
	...
	lea	rcx, OFFSET FLAT:SegmentDir$rtcName$0
	call	_RTC_UninitUse
$LN96@SegmentDir:
...
; 1302 :         else if ( oldcombine  != dir->e.seginfo->combine )
	...
	jne	SHORT $LN97@SegmentDir
	lea	rcx, OFFSET FLAT:SegmentDir$rtcName$1
	call	_RTC_UninitUse
$LN97@SegmentDir:
...
; 1304 :         else if ( oldOfssize  != dir->e.seginfo->Ofssize )
	...
	lea	rcx, OFFSET FLAT:SegmentDir$rtcName$2
	call	_RTC_UninitUse
$LN98@SegmentDir:
...
; 1351 : }
	...
	mov	rdi, rax
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:SegmentDir$rtcFrameData
...
; 476  :             si = LclAlloc( sizeof( struct seg_item ) );
	...
	mov	ecx, 16
	call	LclAlloc
	mov	QWORD PTR si$1[rsp], rax

; 477  :             si->seg = seg;

	mov	rax, QWORD PTR si$1[rsp]
	mov	rcx, QWORD PTR seg$[rsp]
...
; 486  :                 curr = grp->e.grpinfo->seglist;
	...
	mov	rax, QWORD PTR [rax+96]
	mov	rax, QWORD PTR [rax]
	mov	QWORD PTR curr$2[rsp], rax
$LN5@GrpDir:

; 487  :                 while( curr->next != NULL ) {

	mov	rax, QWORD PTR curr$2[rsp]
	cmp	QWORD PTR [rax], 0
	je	SHORT $LN6@GrpDir
...
; 139  :         sym->mem_type = MT_NEAR;
	...
	mov	rax, QWORD PTR sym$[rsp]
	mov	DWORD PTR [rax+36], 129			; 00000081H
...
; 692  : }
	...
	mov	rdi, rax
	mov	rcx, rsp
	lea	rdx, OFFSET FLAT:TypeFromClassName$rtcFrameData
	call	_RTC_CheckStackVars
	mov	rax, rdi
