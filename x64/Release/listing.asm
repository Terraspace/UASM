...
$SG11404 DB	0dH, 0aH, 00H
	ORG $+1
$SG11419 DB	0dH, 0aH, 00H
	ORG $+1
$SG11439 DB	'%u', 00H
	ORG $+1
$SG11450 DB	'?', 00H
	ORG $+2
$SG11458 DB	'%s %s        %s', 00H
$SG11497 DB	'%s %s ', 00H
	ORG $+1
$SG11509 DB	'?', 00H
	ORG $+2
...
$SG11793 DB	'%s ', 00H
$SG11730 DB	'(%.8s) ', 00H
$SG11741 DB	'  %s %s        %-17s %s', 00H
$SG11752 DB	'  %s %s        L %-6s %08X %s', 00H
	ORG $+2
$SG11753 DB	'  %s %s        L %-6s %04X     %s', 00H
	ORG $+2
$SG11770 DB	'%-10s ', 00H
	ORG $+1
$SG11797 DB	'%s ', 00H
...
$SG11187 DB	'Word', 00H
	ORG $+3
$SG11188 DB	'DWord', 00H
	ORG $+2
$SG11189 DB	'FWord', 00H
	ORG $+2
$SG11190 DB	'QWord', 00H
	ORG $+2
$SG11191 DB	'TByte', 00H
	ORG $+2
$SG11192 DB	'Para', 00H
	ORG $+3
$SG11196 DB	'Near16', 00H
	ORG $+1
$SG11211 DB	'Ptr', 00H
$SG11193 DB	'XmmWord', 00H
$SG11194 DB	'Page', 00H
	ORG $+3
$SG11195 DB	'Near', 00H
	ORG $+3
$SG11197 DB	'Near32', 00H
	ORG $+1
$SG11198 DB	'Near64', 00H
	ORG $+1
$SG11200 DB	'Far16', 00H
	ORG $+2
$SG11201 DB	'Far32', 00H
	ORG $+2
$SG11202 DB	'Far64', 00H
	ORG $+2
$SG11203 DB	'L Near', 00H
	ORG $+1
$SG11204 DB	'L Near16', 00H
	ORG $+3
$SG11207 DB	'L Far', 00H
	ORG $+2
$SG11214 DB	'Number', 00H
	ORG $+1
$SG11225 DB	'Abs', 00H
$SG11205 DB	'L Near32', 00H
	ORG $+3
$SG11216 DB	'Stack', 00H
	ORG $+2
$SG11217 DB	'Public', 00H
	ORG $+1
$SG11229 DB	'C', 00H
	ORG $+2
$SG11206 DB	'L Near64', 00H
	ORG $+3
$SG11218 DB	'Common', 00H
	ORG $+5
$SG11208 DB	'L Far16', 00H
$SG11209 DB	'L Far32', 00H
$SG11210 DB	'L Far64', 00H
$SG11212 DB	'Proc', 00H
	ORG $+3
$SG11213 DB	'Func', 00H
	ORG $+3
$SG11215 DB	'Private', 00H
$SG11219 DB	'External', 00H
	ORG $+7
$SG11220 DB	'Undefined', 00H
	ORG $+2
$SG11221 DB	'GROUP', 00H
	ORG $+2
$SG11222 DB	'No Seg', 00H
	ORG $+1
$SG11223 DB	'Text', 00H
	ORG $+3
$SG11224 DB	'Alias', 00H
	ORG $+2
$SG11226 DB	'COMM', 00H
	ORG $+3
$SG11227 DB	'VARARG', 00H
	ORG $+5
$SG11230 DB	'SYSCALL', 00H
$SG11231 DB	'STDCALL', 00H
$SG11232 DB	'PASCAL', 00H
	ORG $+1
$SG11233 DB	'FORTRAN', 00H
$SG11234 DB	'BASIC', 00H
	ORG $+2
$SG11235 DB	'FASTCALL', 00H
	ORG $+7
$SG11236 DB	'Macros:', 00H
$SG11237 DB	'                N a m e                 Type', 00H
	ORG $+3
$SG11238 DB	'Structures and Unions:', 00H
	ORG $+1
$SG11239 DB	'                N a m e                 Size/Ofs   Type', 00H
$SG11240 DB	'Records:', 00H
	ORG $+3
$SG11242 DB	'Types:', 00H
	ORG $+5
$SG11241 DB	'                N a m e                 Width   # fields'
	DB	0aH, '                                        Shift   Width   '
	DB	' Mask   Initial', 00H
	ORG $+7
$SG11243 DB	'                N a m e                 Size    Attr', 00H
	ORG $+3
$SG11244 DB	'Segments and Groups:', 00H
	ORG $+3
$SG11246 DB	'Procedures, parameters and locals:', 00H
	ORG $+5
$SG11245 DB	'                N a m e                 Size     Length '
	DB	'  Align   Combine Class', 00H
$SG11247 DB	'                N a m e                 Type     Value  '
	DB	'  Segment  Length', 00H
	ORG $+6
$SG11248 DB	'Symbols:', 00H
	ORG $+7
...
; 917  :         for ( l = dir->e.procinfo->labellist; l ; l = l->e.nextll ) {
	...
	test	r14, r14
	je	$LN134@log_proc
	lea	r15, OFFSET FLAT:$SG11749
	lea	r13, OFFSET FLAT:$SG11753
	npad	4
$LL19@log_proc:
