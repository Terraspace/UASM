...
$SG11589 DB	'?', 00H
	ORG $+2
$SG11583 DB	'%s %s      %6X  %7X', 00H
$SG11601 DB	' ', 00H
	ORG $+2
$SG11588 DB	'  %s %s      %6X  %7X  %016I64X %s', 00H
	ORG $+1
$SG11603 DB	' ', 00H
	ORG $+2
$SG11590 DB	'  %s %s      %6X  %7X  %08X %s', 00H
	ORG $+1
$SG11604 DB	' ', 00H
	ORG $+2
$SG11663 DB	' ', 00H
	ORG $+2
$SG11605 DB	'%s %s    %8u  %s', 00H
	ORG $+3
$SG11721 DB	'%0*X ', 00H
	ORG $+2
$SG11728 DB	'*%-8s ', 00H
...
$SG11618 DB	'%s %s        ', 00H
	ORG $+2
$SG11621 DB	'32 Bit   %08X ', 00H
	ORG $+1
$SG11624 DB	'64 Bit   %08X ', 00H
	ORG $+1
$SG11625 DB	'16 Bit   %04X     ', 00H
	ORG $+1
$SG11734 DB	'  ', 00H
	ORG $+1
$SG11626 DB	'%-7s %-8s', 00H
	ORG $+2
$SG11628 DB	'''%s''', 00H
	ORG $+3
$SG11729 DB	'%-9s ', 00H
...
$SG11747 DB	'%s[%u]', 00H
	ORG $+1
$SG11790 DB	'%s ', 00H
$SG11648 DB	'%s %s        %s', 00H
$SG11719 DB	'%s %s        P %-6s %08X %-8s ', 00H
	ORG $+1
$SG11720 DB	'%s %s        P %-6s %04X     %-8s ', 00H
	ORG $+1
$SG11724 DB	'%-9s', 00H
	ORG $+3
$SG11727 DB	'%-9s', 00H
...
$SG11794 DB	'%s ', 00H
$SG11731 DB	'(%.8s) ', 00H
$SG11742 DB	'  %s %s        %-17s %s', 00H
$SG11753 DB	'  %s %s        L %-6s %08X %s', 00H
	ORG $+2
$SG11754 DB	'  %s %s        L %-6s %04X     %s', 00H
	ORG $+2
$SG11771 DB	'%-10s ', 00H
	ORG $+1
$SG11798 DB	'%s ', 00H
...
$SG11801 DB	'%s', 00H
	ORG $+1
$SG11200 DB	'Far', 00H
$SG11803 DB	'%s %s        %s   %s', 00H
	ORG $+3
$SG11805 DB	'%s %s        %s  %s', 00H
$SG11187 DB	'Byte', 00H
	ORG $+3
$SG11188 DB	'Word', 00H
	ORG $+3
$SG11189 DB	'DWord', 00H
	ORG $+2
$SG11190 DB	'FWord', 00H
	ORG $+2
$SG11191 DB	'QWord', 00H
	ORG $+2
$SG11192 DB	'TByte', 00H
	ORG $+2
$SG11193 DB	'Para', 00H
	ORG $+3
$SG11197 DB	'Near16', 00H
	ORG $+1
$SG11212 DB	'Ptr', 00H
$SG11194 DB	'XmmWord', 00H
$SG11195 DB	'Page', 00H
	ORG $+3
$SG11196 DB	'Near', 00H
	ORG $+3
$SG11198 DB	'Near32', 00H
	ORG $+1
$SG11199 DB	'Near64', 00H
	ORG $+1
$SG11201 DB	'Far16', 00H
	ORG $+2
$SG11202 DB	'Far32', 00H
	ORG $+2
$SG11203 DB	'Far64', 00H
	ORG $+2
$SG11204 DB	'L Near', 00H
	ORG $+1
$SG11205 DB	'L Near16', 00H
	ORG $+3
$SG11208 DB	'L Far', 00H
	ORG $+2
$SG11215 DB	'Number', 00H
	ORG $+1
$SG11226 DB	'Abs', 00H
$SG11206 DB	'L Near32', 00H
	ORG $+3
$SG11217 DB	'Stack', 00H
	ORG $+2
$SG11218 DB	'Public', 00H
	ORG $+1
$SG11230 DB	'C', 00H
	ORG $+2
$SG11207 DB	'L Near64', 00H
	ORG $+3
$SG11219 DB	'Common', 00H
	ORG $+5
$SG11209 DB	'L Far16', 00H
$SG11210 DB	'L Far32', 00H
$SG11211 DB	'L Far64', 00H
$SG11213 DB	'Proc', 00H
	ORG $+3
$SG11214 DB	'Func', 00H
	ORG $+3
$SG11216 DB	'Private', 00H
$SG11220 DB	'External', 00H
	ORG $+7
$SG11221 DB	'Undefined', 00H
	ORG $+2
$SG11222 DB	'GROUP', 00H
	ORG $+2
$SG11223 DB	'No Seg', 00H
	ORG $+1
$SG11224 DB	'Text', 00H
	ORG $+3
$SG11225 DB	'Alias', 00H
	ORG $+2
$SG11227 DB	'COMM', 00H
	ORG $+3
$SG11228 DB	'VARARG', 00H
	ORG $+5
$SG11231 DB	'SYSCALL', 00H
$SG11232 DB	'STDCALL', 00H
$SG11233 DB	'PASCAL', 00H
	ORG $+1
$SG11234 DB	'FORTRAN', 00H
$SG11235 DB	'BASIC', 00H
	ORG $+2
$SG11236 DB	'FASTCALL', 00H
	ORG $+7
$SG11237 DB	'Macros:', 00H
$SG11238 DB	'                N a m e                 Type', 00H
	ORG $+3
$SG11239 DB	'Structures and Unions:', 00H
	ORG $+1
$SG11240 DB	'                N a m e                 Size/Ofs   Type', 00H
$SG11241 DB	'Records:', 00H
	ORG $+3
$SG11243 DB	'Types:', 00H
	ORG $+5
$SG11242 DB	'                N a m e                 Width   # fields'
	DB	0aH, '                                        Shift   Width   '
	DB	' Mask   Initial', 00H
	ORG $+7
$SG11244 DB	'                N a m e                 Size    Attr', 00H
	ORG $+3
$SG11245 DB	'Segments and Groups:', 00H
	ORG $+3
$SG11247 DB	'Procedures, parameters and locals:', 00H
	ORG $+5
$SG11246 DB	'                N a m e                 Size     Length '
	DB	'  Align   Combine Class', 00H
$SG11248 DB	'                N a m e                 Type     Value  '
	DB	'  Segment  Length', 00H
	ORG $+6
$SG11249 DB	'Symbols:', 00H
	ORG $+7
$SG11250 DB	'                N a m e                 Type       Value'
	DB	'     Attr', 00H
_DATA	ENDS
CONST	SEGMENT
maccap	DW	032H
...
; 917  :         for ( l = dir->e.procinfo->labellist; l ; l = l->e.nextll ) {
	...
	test	r14, r14
	je	$LN134@log_proc
	lea	r15, OFFSET FLAT:$SG11750
	lea	r13, OFFSET FLAT:$SG11754
	npad	4
$LL19@log_proc:
