...
$SG11038 DB	'@Time', 00H
	ORG $+2
$SG11039 DB	'@FileName', 00H
	ORG $+2
$SG11058 DB	'$', 00H
	ORG $+2
$SG11040 DB	'@FileCur', 00H
	ORG $+3
$SG11059 DB	'@Line', 00H
	ORG $+6
$SG11041 DB	'@CurSeg', 00H
$SG11056 DB	'__HJWASM__', 00H
	ORG $+5
$SG11057 DB	'__JWASM__', 00H
	ORG $+6
$SG11060 DB	'@WordSize', 00H
	ORG $+6
$SG11217 DB	'%02u/%02u/%02u', 00H
	ORG $+1
$SG11218 DB	'%02u:%02u:%02u', 00H
_DATA	ENDS
CONST	SEGMENT
tmtab	DQ	FLAT:$SG11035
	DQ	FLAT:$SG11036
