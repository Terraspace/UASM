...
_DATA	ENDS
_DATA	SEGMENT
$SG11762 DB	'_TEXT', 00H
	ORG $+2
$SG11763 DB	'.text', 00H
	ORG $+2
$SG11764 DB	'_DATA', 00H
	ORG $+2
$SG11765 DB	'.data', 00H
	ORG $+2
$SG11766 DB	'CONST', 00H
	ORG $+2
$SG11767 DB	'.rdata', 00H
	ORG $+1
$SG11768 DB	'_BSS', 00H
	ORG $+3
$SG11769 DB	'.bss', 00H
...
$SG11882 DB	'w', 00H
	ORG $+2
$SG11946 DB	'%s', 0aH, 00H
$SG11886 DB	'import ''%s''  %s.%s', 0aH, 00H
$SG11948 DB	0aH, 00H
	ORG $+2
$SG11934 DB	'INCLUDE', 00H
$SG11972 DB	'%r %s', 00H
	ORG $+2
$SG12072 DB	'rb', 00H
	ORG $+1
...
$LN32@SetFilenam:
	...
	lea	rax, OFFSET FLAT:$SG12112
	dec	ecx
	cmp	ecx, 1
	cmovbe	rax, r14
	jmp	SHORT $LN29@SetFilenam
$LN35@SetFilenam:
	lea	rax, OFFSET FLAT:$SG12113
$LN29@SetFilenam:
	sub	rdx, rax
	npad	9
$LL16@SetFilenam:
