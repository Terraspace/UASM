...
$SG12375 DB	' ', 00H
	ORG $+2
$SG11856 DB	'.hdr$1', 00H
	ORG $+1
$SG11903 DB	'HDR', 00H
$SG11858 DB	'%r DOTNAME', 00H
	ORG $+1
$SG11859 DB	'.hdr$', 00H
	ORG $+2
$SG11862 DB	'%s1 %r', 00H
	ORG $+1
$SG11932 DB	'HDR', 00H
$SG11860 DB	'%s1 %r USE16 %r %s', 00H
	ORG $+1
$SG11861 DB	'.hdr$', 00H
	ORG $+2
$SG11864 DB	'.hdr$1', 00H
	ORG $+1
$SG11875 DB	'.hdr$2', 00H
	ORG $+1
$SG11900 DB	'.hdr$2', 00H
	ORG $+1
$SG11904 DB	'.hdr$2', 00H
	ORG $+5
$SG11906 DB	'@pe_file_flags', 00H
	ORG $+1
$SG11930 DB	'.hdr$3', 00H
	ORG $+1
$SG11933 DB	'.hdr$3', 00H
	ORG $+1
$SG11941 DB	'CONST', 00H
	ORG $+2
$SG11945 DB	'.rsrc', 00H
	ORG $+2
$SG11948 DB	'.reloc', 00H
	ORG $+1
$SG12001 DB	'%r DOTNAME', 00H
	ORG $+5
$SG12002 DB	'%s %r %r %s', 00H
$SG12011 DB	'DW %u', 00H
	ORG $+6
$SG12003 DB	'DD 0, 0%xh, 0, %r @%s_name, %u, %u, %u, %r @%s_func, %r '
	DB	'@%s_names, %r @%s_nameord', 00H
	ORG $+6
$SG12005 DB	'@%s_func %r DWORD', 00H
	ORG $+6
$SG12007 DB	'DD %r %s', 00H
	ORG $+7
$SG12008 DB	'@%s_names %r DWORD', 00H
	ORG $+5
$SG12009 DB	'DD %r @%s', 00H
	ORG $+6
$SG12010 DB	'@%s_nameord %r WORD', 00H
	ORG $+4
$SG12014 DB	'@%s_name DB ''%s'',0', 00H
	ORG $+5
$SG12016 DB	'@%s DB ''%s'',0', 00H
	ORG $+2
$SG12017 DB	'%s %r', 00H
	ORG $+2
$SG12042 DB	'ALIGN(8)', 00H
	ORG $+7
$SG12043 DB	'ALIGN(4)', 00H
	ORG $+7
$SG12046 DB	'@LPPROC %r %r %r', 00H
	ORG $+7
$SG12047 DB	'%r DOTNAME', 00H
	ORG $+5
$SG12049 DB	'%s2 %r %r %s', 00H
	ORG $+3
$SG12050 DB	'DD %r @%s_ilt, 0, 0, %r @%s_name, %r @%s_iat', 00H
	ORG $+3
$SG12051 DB	'%s2 %r', 00H
	ORG $+1
$SG12052 DB	'%s4 %r %s %s', 00H
	ORG $+3
$SG12053 DB	'@%s_ilt label %r', 00H
	ORG $+7
$SG12055 DB	'@LPPROC %r @%s_name', 00H
	ORG $+4
$SG12056 DB	'@LPPROC 0', 00H
	ORG $+2
$SG12057 DB	'%s4 %r', 00H
	ORG $+5
$SG12058 DB	'%s5 %r %s %s', 00H
	ORG $+3
$SG12059 DB	'@%s_iat label %r', 00H
	ORG $+7
$SG12061 DB	'%s%s @LPPROC %r @%s_name', 00H
	ORG $+7
$SG12062 DB	'@LPPROC 0', 00H
	ORG $+2
$SG12063 DB	'%s5 %r', 00H
	ORG $+5
$SG12064 DB	'%s6 %r %r %s', 00H
	ORG $+3
$SG12066 DB	'@%s_name dw 0', 00H
	ORG $+2
$SG12067 DB	'db ''%s'',0', 00H
	ORG $+2
$SG12068 DB	'even', 00H
	ORG $+7
$SG12071 DB	'@%s_%s_name db ''%s.%s'',0', 00H
	ORG $+7
$SG12072 DB	'@%s_name db ''%s'',0', 00H
	ORG $+1
$SG12073 DB	'even', 00H
	ORG $+3
$SG12074 DB	'%s6 %r', 00H
	ORG $+5
$SG12076 DB	'%s3 %r %r %s', 00H
	ORG $+3
$SG12077 DB	'DD 0, 0, 0, 0, 0', 00H
	ORG $+3
$SG12078 DB	'%s3 %r', 00H
	ORG $+1
$SG12102 DB	'CONST', 00H
	ORG $+2
$SG12225 DB	'.hdr$1', 00H
	ORG $+1
$SG12226 DB	'.hdr$2', 00H
	ORG $+1
$SG12227 DB	'.hdr$3', 00H
	ORG $+1
$SG12231 DB	'RELOC', 00H
	ORG $+2
$SG12232 DB	'.reloc', 00H
	ORG $+5
$SG12261 DB	'.idata$2', 00H
	ORG $+7
$SG12262 DB	'.idata$3', 00H
	ORG $+7
$SG12263 DB	'.idata$5', 00H
	ORG $+3
$SG12265 DB	'.rsrc', 00H
	ORG $+2
$SG12267 DB	'.reloc', 00H
	ORG $+1
$SG12269 DB	'.tls', 00H
	ORG $+3
$SG12273 DB	'.pdata', 00H
_DATA	ENDS
PUBLIC	bin_init
...
; 839  :                 if ( ( memcmp( curr->sym.name, ".rsrc", 5 ) == 0 ) &&
	...
	cmp	eax, DWORD PTR $SG11945
	jne	SHORT $LN21@pe_create_
	movzx	eax, BYTE PTR [rcx+4]
	cmp	al, BYTE PTR $SG11945+4
	jne	SHORT $LN21@pe_create_
