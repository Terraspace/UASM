...
_DATA	ENDS
_DATA	SEGMENT
$SG11284 DB	'READONLY', 00H
	ORG $+3
$SG11285 DB	'BYTE', 00H
	ORG $+3
$SG11286 DB	'WORD', 00H
	ORG $+3
$SG11287 DB	'DWORD', 00H
	ORG $+2
$SG11288 DB	'PARA', 00H
	ORG $+3
$SG11289 DB	'PAGE', 00H
	ORG $+3
$SG11290 DB	'ALIGN', 00H
	ORG $+2
$SG11292 DB	'PUBLIC', 00H
	ORG $+1
$SG11296 DB	'AT', 00H
	ORG $+1
$SG11291 DB	'PRIVATE', 00H
$SG11293 DB	'STACK', 00H
	ORG $+2
$SG11294 DB	'COMMON', 00H
	ORG $+1
$SG11295 DB	'MEMORY', 00H
	ORG $+1
$SG11297 DB	'COMDAT', 00H
	ORG $+1
$SG11298 DB	'USE16', 00H
	ORG $+2
$SG11299 DB	'USE32', 00H
	ORG $+2
$SG11300 DB	'USE64', 00H
	ORG $+2
$SG11301 DB	'FLAT', 00H
	ORG $+3
$SG11302 DB	'INFO', 00H
	ORG $+3
$SG11303 DB	'DISCARD', 00H
$SG11304 DB	'NOCACHE', 00H
$SG11305 DB	'NOPAGE', 00H
	ORG $+1
$SG11306 DB	'SHARED', 00H
	ORG $+1
$SG11307 DB	'EXECUTE', 00H
$SG11308 DB	'READ', 00H
	ORG $+3
$SG11309 DB	'WRITE', 00H
	ORG $+2
$SG11310 DB	'ALIAS', 00H
	ORG $+2
$SG11509 DB	'FLAT', 00H
	ORG $+3
$SG11556 DB	'CONST', 00H
	ORG $+2
$SG11558 DB	'DBTYP', 00H
	ORG $+2
$SG11560 DB	'DBSYM', 00H
	ORG $+2
$SG11563 DB	'CODE', 00H
	ORG $+3
$SG11565 DB	'DATA', 00H
...
; 672  :         if( memcmp( uname, "DBTYP", 6 ) == 0 )
	...
	cmp	ecx, DWORD PTR $SG11558
	jne	SHORT $LN10@TypeFromCl
	cmp	ax, WORD PTR $SG11558+4
	je	SHORT $LN20@TypeFromCl
$LN10@TypeFromCl:
...
; 674  :         if( memcmp( uname, "DBSYM", 6 ) == 0 )
	...
	cmp	ecx, DWORD PTR $SG11560
	jne	SHORT $LN11@TypeFromCl
	cmp	ax, WORD PTR $SG11560+4
	je	SHORT $LN20@TypeFromCl
$LN11@TypeFromCl:
...
; 685  :         if( memcmp( uname + slen - 3, "BSS", 3 ) == 0 )
	...
	cmp	ax, WORD PTR $SG11568
	jne	SHORT $LN16@TypeFromCl
	movzx	eax, BYTE PTR [rcx+2]
	cmp	al, BYTE PTR $SG11568+2
	jne	SHORT $LN16@TypeFromCl
