...
_DATA	ENDS
_DATA	SEGMENT
$SG11301 DB	'.shstrtab', 00H
	ORG $+6
$SG11302 DB	'.symtab', 00H
$SG11303 DB	'.strtab', 00H
$SG11326 DB	'_TEXT', 00H
	ORG $+2
$SG11327 DB	'.text', 00H
	ORG $+2
$SG11328 DB	'_DATA', 00H
	ORG $+2
$SG11329 DB	'.data', 00H
	ORG $+2
$SG11330 DB	'CONST', 00H
	ORG $+2
$SG11331 DB	'.rodata', 00H
$SG11332 DB	'_BSS', 00H
	ORG $+3
$SG11333 DB	'.bss', 00H
	ORG $+3
...
$SG11536 DB	'.rel', 00H
	ORG $+3
$SG11592 DB	'CONST', 00H
	ORG $+2
$SG11641 DB	'CONST', 00H
	ORG $+2
$SG11742 DB	07fH, 'ELF', 00H
	ORG $+3
$SG11745 DB	07fH, 'ELF', 00H
_DATA	ENDS
CONST	SEGMENT
internal_segparms DQ FLAT:$SG11301
	DD	03H
	ORG $+4
	DQ	FLAT:$SG11302
	DD	02H
