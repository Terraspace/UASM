...
$SG11032 DB	'shl %r,1', 00H
	ORG $+7
$SG11033 DB	'shl %r,1', 00H
	ORG $+7
$SG11035 DB	'mov %r,%r', 00H
	ORG $+6
$SG11036 DB	'add %r,%r', 00H
	ORG $+6
...
$SG11047 DB	'mov %r,DGROUP', 00H
	ORG $+2
$SG11048 DB	'mov %r,%r', 00H
	ORG $+6
$SG11050 DB	'mov %r,0', 00H
	ORG $+7
$SG11052 DB	'push %r', 00H
$SG11053 DB	'call DOSEXIT', 00H
	ORG $+3
$SG11055 DB	'mov %r,4ch', 00H
	ORG $+5
$SG11056 DB	'int 21h', 00H
$SG11083 DB	'org 100h', 00H
	ORG $+3
$SG11084 DB	'%s::', 00H
	ORG $+7
$SG11098 DB	'mov %r,%s', 00H
	ORG $+6
$SG11102 DB	'mov %r,4C00h + %u', 00H
	ORG $+6
$SG11103 DB	'mov %r,%s', 00H
	ORG $+6
$SG11104 DB	'mov %r,4Ch', 00H
_DATA	ENDS
CONST	SEGMENT
StartupDosNear0 DQ FLAT:$SG11026
	DW	0bH
	DW	00H
	ORG $+4
	DQ	FLAT:$SG11027
