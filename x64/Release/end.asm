...
_BSS	ENDS
_DATA	SEGMENT
$SG11049 DB	'mov %r,DGROUP', 00H
	ORG $+2
$SG11050 DB	'mov %r,%r', 00H
	ORG $+2
$SG11057 DB	'cli', 00H
$SG11051 DB	'mov %r,%r', 00H
	ORG $+2
$SG11060 DB	'sti', 00H
$SG11052 DB	'sub %r,%r', 00H
	ORG $+2
$SG11074 DB	'push 1', 00H
	ORG $+5
$SG11053 DB	'shl %r,1', 00H
	ORG $+7
...
$SG11056 DB	'shl %r,1', 00H
	ORG $+7
$SG11058 DB	'mov %r,%r', 00H
	ORG $+6
$SG11059 DB	'add %r,%r', 00H
	ORG $+6
...
$SG11070 DB	'mov %r,DGROUP', 00H
	ORG $+2
$SG11071 DB	'mov %r,%r', 00H
	ORG $+6
$SG11073 DB	'mov %r,0', 00H
	ORG $+7
$SG11075 DB	'push %r', 00H
$SG11076 DB	'call DOSEXIT', 00H
	ORG $+3
$SG11078 DB	'mov %r,4ch', 00H
	ORG $+5
$SG11079 DB	'int 21h', 00H
$SG11106 DB	'org 100h', 00H
	ORG $+3
$SG11107 DB	'%s::', 00H
	ORG $+7
$SG11121 DB	'mov %r,%s', 00H
	ORG $+6
$SG11125 DB	'mov %r,4C00h + %u', 00H
	ORG $+6
$SG11126 DB	'mov %r,%s', 00H
	ORG $+6
$SG11127 DB	'mov %r,4Ch', 00H
_DATA	ENDS
CONST	SEGMENT
StartupDosNear0 DQ FLAT:$SG11049
	DW	0bH
	DW	00H
	ORG $+4
	DQ	FLAT:$SG11050
...
; 248  :             idata_fixup( &CodeInfo, 0, &opndx );
	...
	add	rcx, rax
	mov	DWORD PTR CodeInfo$1[rbp-232], 643	; 00000283H
