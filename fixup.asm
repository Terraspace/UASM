...
xdata	ENDS
pdata	SEGMENT
$pdata$CreateFixup DD @imagerel($LN6#)
	DD	@imagerel($LN6#+200)
...
; 154  :         switch ( sym->state ) {
	...
	jle	$LN3@SetFixupFr
	cmp	eax, 2
	jle	SHORT $LN6@SetFixupFr
	cmp	eax, 3
	je	SHORT $LN2@SetFixupFr
	cmp	eax, 4
	jne	SHORT $LN3@SetFixupFr
...
; 157  :             if( sym->segment != NULL ) {
	...
	je	SHORT $LN3@SetFixupFr

; 158  :                 if( ign_grp == FALSE && ( grp = (struct dsym *)GetGroup( sym ) ) ) {

	test	dl, dl
	jne	SHORT $LN4@SetFixupFr
	call	GetGroup
	test	rax, rax
	je	SHORT $LN4@SetFixupFr
