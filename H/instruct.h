...
ins (PEXTRW, pextrw,            OpCls( RGT16,    XMM,      I8_U ), F_660F, 1,  no_WDS, 0xC5,     0x00,       P_686|P_SSE2,WSIZE|T1S)
//ins(PEXTRW, 1,                 OpCls( RGT16,    XMM,      I8_U ), F_660F, 1,  no_WDS, 0xC5,     0x00,       P_686|P_SSE1,DSIZE|T1S)
#if SSE4SUPP /* SSE 4.1 */
insn(PEXTRW, 1,                 OpCls( M16,      XMM,      I8_U ), F_660F3A, 0,no_WDS, 0x15,     0x00,       P_686|P_SSE4,DSIZE|T1S)
...
insx(VBROADCASTI32x2, vbroadcasti32x2, OpCls( XMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,QSIZE|T2, RWF_VEX )
insn(VBROADCASTI32x2, 1,               OpCls( YMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,QSIZE|T2)
insn(VBROADCASTI32x2, 2,               OpCls( ZMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,QSIZE|T2)
insx(VBROADCASTF32x2, vbroadcastf32x2, OpCls( YMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x19,     0x00,     P_686|P_AVX ,IZSZ|QSIZE|T2, RWF_VEX )
