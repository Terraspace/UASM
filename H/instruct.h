...
ins (CVTSI2SS, cvtsi2ss,        OpCls( XMM,      RMGT16,   NONE ), F_F30F, 1,  no_WDS, 0x2A,     0x00,       P_686|P_SSE1,DSIZE)
...
ins (CVTTPS2DQ, cvttps2dq,      OpCls( XMM,      XMM_M128, NONE ), F_F30F, 1,  no_WDS, 0x5B,     0x00,       P_686|P_SSE2,W1|QSIZE|FV)
...
ins (CVTSS2SD, cvtss2sd,        OpCls( XMM,      XMM_M32,  NONE ), F_F30F, 1,  no_WDS, 0x5A,     0x00,       P_686|P_SSE2,W1|QSIZE|T1S)
...
ins (MOVD, movd,                OpCls( MMX,      RMGT16,   NONE ), F_0F,   1,  no_WDS, 0x6E,     0x00,       P_586|P_MMX, QSIZE)
insn(MOVD, 1,                   OpCls( XMM,      RMGT16,   NONE ), F_660F, 1,  no_WDS, 0x6E,     0x00,       P_686|P_SSE2,W1|QSIZE|T1S)
#if INTELMOVQ
insn(MOVD, 2,                   OpCls( R32_M32,  MMX,      NONE ), F_0F,   0,  no_WDS, 0x7E,     0x00,       P_586|P_MMX, QSIZE)
insn(MOVD, 3,                   OpCls( R32_M32,  XMM,      NONE ), F_660F, 0,  no_WDS, 0x7E,     0x00,       P_686|P_SSE2,W1|QSIZE|T1S)
#else
...
insn(MOVQ, 5,                   OpCls( RMGT16,   MMX,      NONE ), F_0F,   0,  no_WDS, 0x7E,     0x00,       P_586|P_MMX, QSIZE)
...
ins (PACKSSDW, packssdw,        OpCls( MMX,      MMX_M64,  NONE ), F_0F,   1,  no_WDS, 0x6B,     0x00,       P_586|P_MMX, QSIZE)
insn(PACKSSDW, 1,               OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0x6B,     0x00,       P_686|P_SSE2,W1|QSIZE|FV)
ins (PACKSSWB, packsswb,        OpCls( MMX,      MMX_M64,  NONE ), F_0F,   1,  no_WDS, 0x63,     0x00,       P_586|P_MMX, QSIZE)
insn(PACKSSWB, 1,               OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0x63,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PACKUSWB, packuswb,        OpCls( MMX,      MMX_M64,  NONE ), F_0F,   1,  no_WDS, 0x67,     0x00,       P_586|P_MMX, QSIZE)
insn(PACKUSWB, 1,               OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0x67,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
...
insn(PADDSB, 1,                 OpCls( XMM,    XMM_M128_08,NONE ), F_660F, 1,  no_WDS, 0xEC,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PADDSW, paddsw,            OpCls( MMX,    MMX_M64_16, NONE ), F_0F,   1,  no_WDS, 0xED,     0x00,       P_586|P_MMX, QSIZE)
insn(PADDSW, 1,                 OpCls( XMM,    XMM_M128_16,NONE ), F_660F, 1,  no_WDS, 0xED,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PADDUSB, paddusb,          OpCls( MMX,    MMX_M64_08, NONE ), F_0F,   1,  no_WDS, 0xDC,     0x00,       P_586|P_MMX, QSIZE)
insn(PADDUSB, 1,                OpCls( XMM,    XMM_M128_08,NONE ), F_660F, 1,  no_WDS, 0xDC,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PADDUSW, paddusw,          OpCls( MMX,    MMX_M64_16, NONE ), F_0F,   1,  no_WDS, 0xDD,     0x00,       P_586|P_MMX, QSIZE)
insn(PADDUSW, 1,                OpCls( XMM,    XMM_M128_16,NONE ), F_660F, 1,  no_WDS, 0xDD,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PAND, pand,                OpCls( MMX,      MMX_M64,  NONE ), F_0F,   1,  no_WDS, 0xDB,     0x00,       P_586|P_MMX, QSIZE)
insn(PAND, 1,                   OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xDB,     0x00,       P_686|P_SSE2,W1|QSIZE|FV)
...
insn(PAVGB, 1,                  OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xE0,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
ins (PAVGW, pavgw,              OpCls( MMX,      MMX_M64,  NONE ), F_0F,   1,  no_WDS, 0xE3,     0x00,       P_686|P_SSE1,DSIZE|FVM)
insn(PAVGW, 1,                  OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xE3,     0x00,       P_686|P_SSE2,W1|QSIZE|FVM)
...
ins (PEXTRW, pextrw,            OpCls( RGT16,    MMX,      I8_U ), F_0F,   1,  no_WDS, 0xC5,     0x00,       P_686|P_SSE1,DSIZE|T1S)
...
insn(PSLLW, 2,				    OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xF1,     0x00,		 P_686 | P_SSE2, WSIZE | FVM)
insn(PSLLW, 3,				    OpCls( XMM,      I8_U,     NONE ), F_660F, 0,  no_WDS, 0x71,     0x30,		 P_686 | P_SSE2, WSIZE | T128)
...
insn(PSLLD, 2,				    OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xF2,     0x00,		 P_686 | P_SSE2, DSIZE | FV)
insn(PSLLD, 3,				    OpCls( XMM,      I8_U,     NONE ), F_660F, 0,  no_WDS, 0x72,     0x30,		 P_686 | P_SSE2, DSIZE | T128)
...
insn(PSLLQ, 2,				    OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xF3,     0x00,		 P_686 | P_SSE2, W1 | QSIZE | FV)
insn(PSLLQ, 3,                  OpCls( XMM,      I8_U,     NONE ), F_660F, 0,  no_WDS, 0x73,     0x30,		 P_686 | P_SSE2, W1 | QSIZE | T128)
...
ins (PEXTRB, pextrb,            OpCls( RGT16_M08,XMM,      I8_U ), F_660F3A, 0,  no_WDS, 0x14,     0x00,       P_686|P_SSE4, DSIZE|T1S)
...
insx(VPBROADCASTB, vpbroadcastb,       OpCls( XMM,      R8,         NONE ), F_660F38,1,  no_WDS, 0x7A,     0x00,     P_686|P_AVX ,BSIZE|T1S,RWF_EVEX|RWF_VEX )
insn(VPBROADCASTB, 1,                  OpCls( XMM,      XMM_M08,    NONE ), F_660F38,1,  no_WDS, 0x78,     0x00,     P_686|P_AVX ,BSIZE|T1S)
insx(VPBROADCASTW, vpbroadcastw,       OpCls( XMM,      R16,        NONE ), F_660F38,1,  no_WDS, 0x7B,     0x00,     P_686|P_AVX ,WSIZE|T1S, RWF_EVEX|RWF_VEX )
...
insx(VPBROADCASTQ, vpbroadcastq,       OpCls( XMM,      R64,        NONE ), F_660F38,1,  no_WDS, 0x7C,     0x00,     P_686|P_AVX ,W1|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insn(VPBROADCASTQ, 1,                  OpCls( XMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,W1|QSIZE|T1S)
insx(VBROADCASTI32x2, vbroadcasti32x2, OpCls( XMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,W1|QSIZE|T2, RWF_EVEX|RWF_VEX )
insn(VBROADCASTI32x2, 1,               OpCls( YMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,W1|QSIZE|T2)
insn(VBROADCASTI32x2, 2,               OpCls( ZMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x59,     0x00,     P_686|P_AVX ,W1|QSIZE|T2)
insx(VBROADCASTI32x4, vbroadcasti32x4, OpCls( YMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x5A,     0x00,     P_686|P_AVX ,DSIZE|T4, RWF_EVEX|RWF_VEX )
insn(VBROADCASTI32x4, 1,               OpCls( ZMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x5A,     0x00,     P_686|P_AVX ,DSIZE|T4 )
insx(VBROADCASTI64x2, vbroadcasti64x2, OpCls( YMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x5A,     0x00,     P_686|P_AVX ,W1|QSIZE|T8, RWF_EVEX|RWF_VEX )
insn(VBROADCASTI64x2, 1,               OpCls( ZMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x5A,     0x00,     P_686|P_AVX ,W1|QSIZE|T8)
insx(VBROADCASTI32x8, vbroadcasti32x8, OpCls( ZMM,      M256,       NONE ), F_660F38,1,  no_WDS, 0x5B,     0x00,     P_686|P_AVX ,DSIZE|T2, RWF_EVEX|RWF_VEX )
insx(VBROADCASTI64x4, vbroadcasti64x4, OpCls( ZMM,      M256,       NONE ), F_660F38,1,  no_WDS, 0x5B,     0x00,     P_686|P_AVX ,W1|QSIZE|T4, RWF_EVEX|RWF_VEX )
insx(VBROADCASTF32x4, vbroadcastf32x4, OpCls( YMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX ,DSIZE|T4, RWF_EVEX|RWF_VEX )
insn(VBROADCASTF32x4, 1,               OpCls( ZMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX ,DSIZE|T4 )
insx(VBROADCASTF64x2, vbroadcastf64x2, OpCls( YMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX ,W1|QSIZE|T2, RWF_EVEX|RWF_VEX )
insn(VBROADCASTF64x2, 1,               OpCls( ZMM,      M128,       NONE ), F_660F38,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX ,W1|QSIZE|T2)
insx(VBROADCASTF32x8, vbroadcastf32x8, OpCls( ZMM,      M256,       NONE ), F_660F38,1,  no_WDS, 0x5B,     0x00,     P_686|P_AVX ,DSIZE|T8, RWF_EVEX|RWF_VEX )
insx(VBROADCASTF64x4, vbroadcastf64x4, OpCls( ZMM,      M256,       NONE ), F_660F38,1,  no_WDS, 0x5B,     0x00,     P_686|P_AVX ,W1|QSIZE|T4, RWF_EVEX|RWF_VEX )
//VPBROADCASTMB2Q xmm1, k1  EVEX.128.F3.0F38.W1 2A /r RM
//VPBROADCASTMW2D xmm1, k1  EVEX.128.F3.0F38.W0 3A /r RM
insx(VPBROADCASTMB2Q, vpbroadcastmb2q, OpCls( XMM,      R8,         NONE ), F_F30F38,1,  no_WDS, 0x2A,     0x00,     P_686|P_AVX ,W1|BSIZE,RWF_EVEX|RWF_VEX )
...
insn(VEXTRACTF32x4, 2,                 OpCls( XMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, DSIZE|T4)
insn(VEXTRACTF32x4, 3,                 OpCls( M128,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, DSIZE|T4)

insx(VEXTRACTF64x2, vextractf64x2,     OpCls( XMM,      YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, W1|QSIZE|T2, RWF_EVEX|RWF_VEX )
insn(VEXTRACTF64x2, 1,                 OpCls( M128,     YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, W1|QSIZE|T2)
insn(VEXTRACTF64x2, 2,                 OpCls( XMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, W1|QSIZE|T2)
insn(VEXTRACTF64x2, 3,                 OpCls( M128,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x19,     0x00,     P_686|P_AVX, W1|QSIZE|T2)

insx(VEXTRACTF32x8, vextractf32x8,     OpCls( YMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x1B,     0x00,     P_686|P_AVX, DSIZE|T8, RWF_EVEX|RWF_VEX )
insn(VEXTRACTF32x8, 1,                 OpCls( M256,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x1B,     0x00,     P_686|P_AVX, DSIZE|T8)

insx(VEXTRACTF64x4, vextractf64x4,     OpCls( YMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x1B,     0x00,     P_686|P_AVX, W1|QSIZE|T4, RWF_EVEX|RWF_VEX )
insn(VEXTRACTF64x4, 1,                 OpCls( M256,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x1B,     0x00,     P_686|P_AVX, W1|QSIZE|T4)
...
insx(VEXTRACTI32x4, vextracti32x4,     OpCls( XMM,      YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, DSIZE|T4, RWF_EVEX|RWF_VEX )
insn(VEXTRACTI32x4, 1,                 OpCls( M128,     YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, DSIZE|T4)
insn(VEXTRACTI32x4, 2,                 OpCls( XMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, DSIZE|T4)
insn(VEXTRACTI32x4, 3,                 OpCls( M128,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, DSIZE|T4)

insx(VEXTRACTI64x2, vextracti64x2,     OpCls( XMM,      YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, W1|QSIZE|T2, RWF_EVEX|RWF_VEX )
insn(VEXTRACTI64x2, 1,                 OpCls( M128,     YMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, W1|QSIZE|T2)
insn(VEXTRACTI64x2, 2,                 OpCls( XMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, W1|QSIZE|T2)
insn(VEXTRACTI64x2, 3,                 OpCls( M128,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x39,     0x00,     P_686|P_AVX, W1|QSIZE|T2)

insx(VEXTRACTI32x8, vextracti32x8,     OpCls( YMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x3B,     0x00,     P_686|P_AVX, DSIZE|T8, RWF_EVEX|RWF_VEX )
insn(VEXTRACTI32x8, 1,                 OpCls( M256,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x3B,     0x00,     P_686|P_AVX, DSIZE|T8)

insx(VEXTRACTI64x4, vextracti64x4,     OpCls( YMM,      ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x3B,     0x00,     P_686|P_AVX, W1|QSIZE|T4, RWF_EVEX|RWF_VEX )
insn(VEXTRACTI64x4, 1,                 OpCls( M256,     ZMM,        I8_U ), F_660F3A,0,  no_WDS, 0x3B,     0x00,     P_686|P_AVX, W1|QSIZE|T4)
...
insx(VCVTPD2DQ, vcvtpd2dq,             OpCls( XMM,      XMM_M128,   NONE ), F_F20F,  1,  no_WDS, 0xE6,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_VEX )
insx(VCVTPD2UDQ, vcvtpd2udq,           OpCls( XMM,      XMM_M128,   NONE ), F_0F,    1,  no_WDS, 0x79,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_VEX )
insx(VCVTPS2UDQ, vcvtps2udq,           OpCls( XMM,      XMM_M128,   NONE ), F_0F,    1,  no_WDS, 0x79,     0x00,     P_686|P_AVX, DSIZE|FV, RWF_VEX )
insx(VCVTTPD2DQ, vcvttpd2dq,           OpCls( XMM,      XMM_M128,   NONE ), F_660F,  1,  no_WDS, 0xE6,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_VEX )
insx(VCVTPD2PS, vcvtpd2ps,             OpCls( XMM,      XMM_M128,   NONE ), F_660F,  1,  no_WDS, 0x5A,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_VEX )
insx(VMOVDDUP, vmovddup,               OpCls( XMM,      XMM_M64,    NONE ), F_F20F,  1,  no_WDS, 0x12,     0x00,     P_686|P_AVX, W1|QSIZE|DUP, RWF_VEX )
/* v2.13: added here  */
...
insx(VPGATHERQD, vpgatherqd,         OpCls( XMM, XMM_M32,    NONE ), F_660F38,1,  no_WDS,0x91, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX )
...
insx(VGATHERDPD, vgatherdpd,         OpCls( XMM, XMM_M64,    NONE ), F_660F38,1,  no_WDS,0x92, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX ) 
insx(VGATHERQPD, vgatherqpd,         OpCls( XMM, XMM_M64,    NONE ), F_660F38,1,  no_WDS,0x93, 0x00,     P_686|P_AVX, IXSZ|T1S, RWF_EVEX|RWF_VEX ) 
...
insx(VPSCATTERDD, vpscatterdd,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA0, 0x00,     P_686|P_AVX, IXSZ|DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPSCATTERDQ, vpscatterdq,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA0, 0x00,     P_686|P_AVX, IXSZ|DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPSCATTERQD, vpscatterqd,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA1, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPSCATTERQQ, vpscatterqq,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA1, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VSCATTERDPS, vscatterdps,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA2, 0x00,     P_686|P_AVX, IXSZ|DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VSCATTERDPD, vscatterdpd,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA2, 0x00,     P_686|P_AVX, IXSZ|DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VSCATTERQPS, vscatterqps,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA3, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VSCATTERQPD, vscatterqpd,       OpCls( XMM_M32, XMM,    NONE ), F_660F38,0,  no_WDS,0xA3, 0x00,     P_686|P_AVX, W1|IXSZ|QSIZE|T1S, RWF_EVEX|RWF_VEX )
...
insx(VPANDQ, vpandq,                 OpCls( XMM,   XMM_M128, NONE ), F_660F,  1,  no_WDS,0xDB, 0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_VEX )
insx(VPANDND, vpandnd,               OpCls( XMM,   XMM_M128, NONE ), F_660F,  1,  no_WDS,0xDF, 0x00,     P_686|P_AVX ,DSIZE|FV,RWF_VEX )
insx(VPANDNQ, vpandnq,               OpCls( XMM,   XMM_M128, NONE ), F_660F,  1,  no_WDS,0xDF, 0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_VEX )
insx(VPBLENDMD, vpblendmd,           OpCls( XMM,   XMM_M128, NONE ), F_660F38,1,  no_WDS,0x64, 0x00,     P_686|P_AVX ,DSIZE|FV,RWF_VEX )
insx(VPBLENDMQ, vpblendmq,           OpCls( XMM,   XMM_M128, NONE ), F_660F38,1,  no_WDS,0x64, 0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_VEX )
...
insx(VGETEXPPD, vgetexppd,         OpCls( XMM, XMM_M128_M64, NONE ), F_660F38, 1,no_WDS,0x42,  0x00,     P_686|P_AVX ,W1|QSIZE|FV ,RWF_VEX)
insx(VGETEXPPS, vgetexpps,         OpCls( XMM, XMM_M128_M32, NONE ), F_660F38, 1,no_WDS,0x42,  0x00,     P_686|P_AVX ,DSIZE|FV ,RWF_VEX)
insx(VGETEXPSD, vgetexpsd,         OpCls( XMM, XMM_M64, NONE ), F_660F38, 1,  no_WDS,0x43,     0x00,     P_686|P_AVX ,W1|QSIZE|T1S ,RWF_VEX)
insx(VGETEXPSS, vgetexpss,         OpCls( XMM, XMM_M32, NONE ), F_660F38, 1,  no_WDS,0x43,     0x00,     P_686|P_AVX ,DSIZE|T1S ,RWF_VEX)
insx(VCVTPH2PS, vcvtph2ps,         OpCls( XMM, XMM_M64, NONE ), F_660F38,1,  no_WDS, 0x13,     0x00,     P_686|P_AVX, WSIZE|HVM, RWF_VEX )
insx(VCVTPS2PH, vcvtps2ph,         OpCls(XMM,  XMM_M128, I8_U ), F_660F3A, 0,  no_WDS, 0x1D,    0x00,     P_686|P_AVX, DSIZE|HVM, RWF_VEX )
...
insx(VGETMANTPD, vgetmantpd,       OpCls( XMM,  XMM_M128, I8_U), F_660F3A, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VGETMANTPS, vgetmantps,       OpCls( XMM,  XMM_M128, I8_U), F_660F3A, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX ,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VGETMANTSD, vgetmantsd,       OpCls( XMM,  XMM_M64,  I8_U), F_660F3A, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX ,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VGETMANTSS, vgetmantss,       OpCls( XMM,  XMM_M32,  I8_U), F_660F3A, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX ,DSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VALIGND,    valignd,          OpCls( XMM,  XMM_M128, I8_U), F_660F3A, 1,  no_WDS,0x03,     0x00,     P_686|P_AVX ,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VALIGNQ,    valignq,          OpCls( XMM,  XMM_M128, I8_U), F_660F3A, 1,  no_WDS,0x03,     0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VBLENDMPD, vblendmpd,         OpCls( XMM,  XMM, XMM_M128),  F_660F38, 1,  no_WDS,0x65,     0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VBLENDMPS, vblendmps,         OpCls( XMM,  XMM, XMM_M128),  F_660F38, 1,  no_WDS,0x65,     0x00,     P_686|P_AVX ,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VCOMPRESSPD, vcompresspd,     OpCls( XMM_M128, XMM, NONE ), F_660F38, 0,  no_WDS,0x8A,     0x00,     P_686|P_AVX, W1|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VCOMPRESSPS, vcompressps,     OpCls( XMM_M128, XMM, NONE ), F_660F38, 0,  no_WDS,0x8A,     0x00,     P_686|P_AVX, DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPCOMPRESSD, vpcompressd,     OpCls( XMM_M128, XMM, NONE ), F_660F38, 0,  no_WDS,0x8B,     0x00,     P_686|P_AVX, DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPCOMPRESSQ, vpcompressq,     OpCls( XMM_M128, XMM, NONE ), F_660F38, 0,  no_WDS,0x8B,     0x00,     P_686|P_AVX, W1|QSIZE|T1S, RWF_EVEX|RWF_VEX )
...
insx(VCVTUDQ2PD, vcvtudq2pd,       OpCls( XMM, XMM_M64,  NONE ), F_F30F,   1,  no_WDS,0x7A,     0x00,     P_686|P_AVX, DSIZE|HV, RWF_EVEX|RWF_VEX )
insx(VCVTUDQ2PS, vcvtudq2ps,       OpCls( XMM, XMM_M128, NONE ), F_F20F,   1,  no_WDS,0x7A,     0x00,     P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VEXPANDPD, vexpandpd,         OpCls( XMM, XMM_M128, NONE ), F_660F38, 1,  no_WDS,0x88,     0x00,     P_686|P_AVX, W1|QSIZE|T1S,RWF_EVEX|RWF_VEX )
insx(VEXPANDPS, vexpandps,         OpCls( XMM, XMM_M128, NONE ), F_660F38, 1,  no_WDS,0x88,     0x00,     P_686|P_AVX, DSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VPCMPD, vpcmpd,               OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x1F,     0x00,     P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPCMPUD, vpcmpud,             OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x1E,     0x00,     P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPCMPQ, vpcmpq,               OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x1F,     0x00,     P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPCMPUQ, vpcmpuq,             OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x1E,     0x00,     P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPCMPW, vpcmpw,               OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x3F,     0x00,     P_686|P_AVX,W1|WSIZE|FVM, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPCMPUW, vpcmpuw,             OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x3E,     0x00,     P_686|P_AVX,W1|WSIZE|FVM, RWF_EVEX|RWF_VEX )
insx(VPCMPB, vpcmpb,               OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x3F,     0x00,     P_686|P_AVX,BSIZE|FVM, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPCMPUB, vpcmpub,             OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x3E,     0x00,     P_686|P_AVX,BSIZE|FVM, RWF_EVEX|RWF_VEX )

insx(VPCMPEQD,   vpcmpeqd,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPLTD,   vpcmpltd,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPLED,   vpcmpled,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPFALSED,vpcmpfalsed,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPNEQD,  vpcmpneqd,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPNLTD,  vpcmpnltd,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPNLED,  vpcmpnled,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
insx(VPCMPTRUED, vpcmptrued,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,DSIZE|FV, RWF_VEX )
...
insx(VPCMPEQQ,    vpcmpeqq,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPLTQ,    vpcmpltq,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPLEQ,    vpcmpleq,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPFALSEQ, vpcmpfalseq,    OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNEQQ,   vpcmpneqq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNLTQ,   vpcmpnltq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNLEQ,   vpcmpnleq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPTRUEQ,  vpcmptrueq,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1F,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )

insx(VPCMPEQUQ,   vpcmpequq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPLTUQ,   vpcmpltuq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPLEUQ,   vpcmpleuq,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPFALSEUQ,vpcmpfalseuq,   OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNEQUQ,  vpcmpnequq,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNLTUQ,  vpcmpnltuq,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPNLEUQ,  vpcmpnleuq,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )
insx(VPCMPTRUEUQ, vpcmptrueuq,    OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x1E,     0x00,       P_686|P_AVX,W1|QSIZE|FV, RWF_VEX )

insx(VPCMPEQW,    vpcmpeqw,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPLTW,    vpcmpltw,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPLEW,    vpcmplew,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPFALSEW, vpcmpfalsew,    OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNEQW,   vpcmpneqw,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNLTW,   vpcmpnltw,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNLEW,   vpcmpnlew,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPTRUEW,  vpcmptruew,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )

insx(VPCMPEQUW,   vpcmpequw,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPLTUW,   vpcmpltuw,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPLEUW,   vpcmpleuw,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPFALSEUW,vpcmpfalseuw,   OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNEQUW,  vpcmpnequw,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNLTUW,  vpcmpnltuw,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPNLEUW,  vpcmpnleuw,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )
insx(VPCMPTRUEUW, vpcmptrueuw,    OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,W1|QSIZE|FVM, RWF_VEX )

insx(VPCMPEQB,   vpcmpeqb,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPLTB,   vpcmpltb,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPLEB,   vpcmpleb,        OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPFALSEB,vpcmpfalseb,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNEQB,  vpcmpneqb,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNLTB,  vpcmpnltb,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNLEB,  vpcmpnleb,       OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPTRUEB, vpcmptrueb,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3F,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )

insx(VPCMPEQUB,   vpcmpequb,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPLTUB,   vpcmpltub,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPLEUB,   vpcmpleub,      OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPFALSEUB,vpcmpfalseub,   OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNEQUB,  vpcmpnequb,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNLTUB,  vpcmpnltub,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPNLEUB,  vpcmpnleub,     OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPCMPTRUEUB, vpcmptrueub,    OpCls( XMM,     XMM_M128, HID ), F_660F3A, 1,  no_WDS, 0x3E,     0x00,       P_686|P_AVX,BSIZE|FVM, RWF_VEX )
insx(VPERMD, vpermd,              OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x36,     0x00,     P_686|P_AVX ,DSIZE|FV,RWF_VEX )
insx(VPERMW, vpermw,              OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x8D,     0x00,     P_686|P_AVX ,W1|WSIZE|FV,RWF_EVEX|RWF_VEX )
insx(VPERMB, vpermb,              OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x8D,     0x00,     P_686|P_AVX ,BSIZE|FV,RWF_EVEX|RWF_VEX )

insx(VPEXPANDD, vpexpandd,  OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x89,     0x00,     P_686|P_AVX ,DSIZE|T1S,RWF_EVEX|RWF_VEX )
insx(VPEXPANDQ, vpexpandq,  OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x89,     0x00,     P_686|P_AVX ,QSIZE|FV|W1,RWF_EVEX|RWF_VEX)
insx(VPMAXSQ, vpmaxsq,      OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x3D,     0x00,     P_686|P_AVX ,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPMAXUQ, vpmaxuq,      OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x3F,     0x00,     P_686|P_AVX, W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPMINSQ, vpminsq,      OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x39,     0x00,     P_686|P_AVX, W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPMINUQ, vpminuq,      OpCls( XMM,     XMM_M128,   NONE ), F_660F38, 1,  no_WDS,0x3B,     0x00,     P_686|P_AVX, W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPORD,   vpord,        OpCls( XMM,     XMM_M128,   NONE ), F_660F,   1,  no_WDS,0xEB,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPORQ,   vporq,        OpCls( XMM,     XMM_M128,   NONE ), F_660F,   1,  no_WDS,0xEB,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
...
insx(VPROLD,  vprold,       OpCls( XMM,      I8_U,      NONE ), F_660F,   0,  no_WDS,0x72,     0x08,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPROLVD, vprolvd,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x15,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPROLQ,  vprolq,       OpCls( XMM,      I8_U,      NONE ), F_660F,   0,  no_WDS,0x72,     0x08,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPROLVQ, vprolvq,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x15,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPRORD,  vprord,       OpCls( XMM,      I8_U,      NONE ), F_660F,   0,  no_WDS,0x72,     0x01,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPRORVD, vprorvd,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x14,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPRORQ,  vprorq,       OpCls( XMM,      I8_U,      NONE ), F_660F,   0,  no_WDS,0x72,     0x01,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPRORVQ, vprorvq,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x14,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPSRAQ, vpsraq,        OpCls( XMM,      I8_U,      NONE ), F_660F,   0,  no_WDS,0x72,     0x20,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
...
insx(VPSRAVQ, vpsravq,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x46,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPSRAVW, vpsravw,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x11,     0x00,     P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPSRLVD, vpsrlvd,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x45,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPSRLVQ, vpsrlvq,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x45,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPSRLVW, vpsrlvw,      OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x10,     0x00,     P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPTESTMB, vptestmb,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX,BSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPTESTMW, vptestmw,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPTESTMD, vptestmd,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPTESTMQ, vptestmq,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPTESTNMB, vptestnmb,  OpCls( XMM,      XMM_M128,  NONE ), F_F30F38, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX,BSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPTESTNMW, vptestnmw,  OpCls( XMM,      XMM_M128,  NONE ), F_F30F38, 1,  no_WDS,0x26,     0x00,     P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPTESTNMD, vptestnmd,  OpCls( XMM,      XMM_M128,  NONE ), F_F30F38, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPTESTNMQ, vptestnmq,  OpCls( XMM,      XMM_M128,  NONE ), F_F30F38, 1,  no_WDS,0x27,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
//VREDUCEPD xmm1 {k1}{z},xmm2/m128/m64bcst, imm8  EVEX.128.66.0F3A.W1 56 /r ib FV EVEX.vvvv is reserved and must be 1111b
//VREDUCESD xmm1 {k1}{z},xmm2,xmm3/m64{sae},imm8  EVEX.NDS.LIG.66.0F3A.W1 57 /r T1S
//VREDUCEPS xmm1 {k1}{z},xmm2/m128/m32bcst, imm8  EVEX.128.66.0F3A.W0 56 /r ib FV EVEX.vvvv is reserved and must be 1111b
//VREDUCESS xmm1 {k1}{z},xmm2, xmm3/m32{sae},imm8 EVEX.NDS.LIG.66.0F3A.W0 57 /r /ib T1S
insx(VREDUCEPD, vreducepd,  OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x56,     0x00,     P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VREDUCESD, vreducesd,  OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x57,     0x00,     P_686|P_AVX,W1|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VREDUCEPS, vreduceps,  OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x56,     0x00,     P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VREDUCESS, vreducess,  OpCls( XMM,  XMM_M128, I8_U ),F_660F3A, 1,  no_WDS,0x57,     0x00,     P_686|P_AVX,DSIZE|T1S, RWF_EVEX|RWF_VEX )


insx(VPXORD, vpxord,        OpCls( XMM,      XMM_M128,  NONE ), F_660F,   1,  no_WDS,0xEF,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPXORQ, vpxorq,        OpCls( XMM,      XMM_M128,  NONE ), F_660F,   1,  no_WDS,0xEF,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRCP14PD, vrcp14pd,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4C,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRCP14SD, vrcp14sd,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4D,     0x00,     P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VRCP14PS, vrcp14ps,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4C,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRCP14SS, vrcp14ss,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4D,     0x00,     P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)

insx(VRSQRT14PD, vrsqrt14pd,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4E,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRSQRT14SD, vrsqrt14sd,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4F,     0x00,     P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VRSQRT14PS, vrsqrt14ps,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4E,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRSQRT14SS, vrsqrt14ss,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x4F,     0x00,     P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)

insx(VPTERNLOGD, vpternlogd,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x25,     0x00,    P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPTERNLOGQ, vpternlogq,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x25,     0x00,    P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
...
insx(VPMOVQB, vpmovqb,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x32,     0x00,    P_686|P_AVX,QSIZE|OVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSQB, vpmovsqb,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x22,     0x00,    P_686|P_AVX,QSIZE|OVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSQB, vpmovusqb,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x12,     0x00,    P_686|P_AVX,QSIZE|OVM,RWF_EVEX|RWF_VEX)

insx(VPMOVQW, vpmovqw,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x34,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSQW, vpmovsqw,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x24,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSQW, vpmovusqw,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x14,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)

insx(VPMOVQD, vpmovqd,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x35,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSQD, vpmovsqd,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x25,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSQD, vpmovusqd,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x15,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)

insx(VPMOVDB, vpmovdb,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x31,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSDB, vpmovsdb,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x21,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSDB, vpmovusdb,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x11,     0x00,    P_686|P_AVX,QSIZE|QVM,RWF_EVEX|RWF_VEX)

insx(VPMOVDW, vpmovdw,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x33,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSDW, vpmovsdw,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x23,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSDW, vpmovusdw,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x13,     0x00,    P_686|P_AVX,QSIZE|HVM,RWF_EVEX|RWF_VEX)

insx(VPMOVWB, vpmovwb,          OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x30,     0x00,    P_686|P_AVX,WSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVSWB, vpmovswb,        OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x20,     0x00,    P_686|P_AVX,WSIZE|HVM,RWF_EVEX|RWF_VEX)
insx(VPMOVUSWB, vpmovuswb,      OpCls( XMM_M_ANY,     XMM,       NONE ), F_F30F38,   0,  no_WDS, 0x10,     0x00,    P_686|P_AVX,WSIZE|HVM,RWF_EVEX|RWF_VEX)


insx(VSHUFF32X4, vshuff32x4,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x23,     0x00,    P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VSHUFF64X2, vshuff64x2,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x23,     0x00,    P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VSHUFI32X4, vshufi32x4,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x43,     0x00,    P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                            
insx(VSHUFI64X2, vshufi64x2,    OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x43,     0x00,    P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
...
insx(VPERMT2W, vpermt2w,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x7D,     0x00,     P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insx(VPERMT2D, vpermt2d,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x7E,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPERMT2Q, vpermt2q,    OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x7E,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPERMT2PS, vpermt2ps,  OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x7F,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VPERMT2PD, vpermt2pd,  OpCls( XMM,      XMM_M128,  NONE ), F_660F38, 1,  no_WDS,0x7F,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
//VCVTPD2QQ,VCVTPD2UDQ,VCVTPD2UQQ,VCVTPS2UDQ,VCVTPS2QQ,VCVTPS2UQQ,VCVTQQ2PD,VCVTQQ2PS,VCVTSD2USI,VCVTSS2USI
insx(VCVTSD2USI, vcvtsd2usi,    OpCls( R32,    XMM_M64,  NONE ), F_F20F, 1,  no_WDS, 0x79,     0x00,       P_686|P_AVX,QSIZE|T1F64,RWF_EVEX|RWF_VEX)
insn(VCVTSD2USI, 1,             OpCls( R64,    XMM_M64,  NONE ), F_F20F, 1,  no_WDS, 0x79,     0x00,       P_686|P_AVX,W1|QSIZE|T1F64)
insx(VCVTSS2USI, vcvtss2usi,    OpCls( R32,    XMM_M32,  NONE ), F_F30F, 1,  no_WDS, 0x79,     0x00,       P_686|P_AVX,DSIZE|T1F32,RWF_EVEX|RWF_VEX)
insn(VCVTSS2USI, 1,             OpCls( R64,    XMM_M32,  NONE ), F_F30F, 1,  no_WDS, 0x79,     0x00,       P_686|P_AVX,W1|DSIZE|T1F32)
insx(VCVTUSI2SD, vcvtusi2sd,    OpCls( XMM,    R32_M32,  NONE ), F_F20F, 1,  no_WDS, 0x7B,     0x00,       P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)
insn(VCVTUSI2SD, 1,             OpCls( XMM,    R64_M64,  NONE ), F_F20F, 1,  no_WDS, 0x7B,     0x00,       P_686|P_AVX,W1|QSIZE|T1S)
insx(VCVTUSI2SS, vcvtusi2ss,    OpCls( XMM,    R32_M32,  NONE ), F_F30F, 1,  no_WDS, 0x7B,     0x00,       P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)
insn(VCVTUSI2SS, 1,             OpCls( XMM,    R64_M64,  NONE ), F_F30F, 1,  no_WDS, 0x7B,     0x00,       P_686|P_AVX,W1|QSIZE|T1S)

insx(VSCALEFPD, vscalefpd,    OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1,  no_WDS, 0x2C,     0x00,       P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VSCALEFPS, vscalefps,    OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1,  no_WDS, 0x2C,     0x00,       P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VSCALEFSD, vscalefsd,    OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1,  no_WDS, 0x2D,     0x00,       P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VSCALEFSS, vscalefss,    OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1,  no_WDS, 0x2D,     0x00,       P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)

insx(VFIXUPIMMPD, vfixupimmpd, OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x54,     0x00,    P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)                                                                                                                      
insx(VFIXUPIMMPS, vfixupimmps, OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS, 0x54,     0x00,    P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)                                                                                                                      
insx(VFIXUPIMMSD, vfixupimmsd, OpCls( XMM,      XMM_M64,   I8_U ), F_660F3A, 1,  no_WDS, 0x55,     0x00,    P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VFIXUPIMMSS, vfixupimmss, OpCls( XMM,      XMM_M32,   I8_U ), F_660F3A, 1,  no_WDS, 0x55,     0x00,    P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)

insx(VRNDSCALEPD, vrndscalepd,OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS,0x09,     0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRNDSCALEPS, vrndscaleps,OpCls( XMM,      XMM_M128,  I8_U ), F_660F3A, 1,  no_WDS,0x08,     0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx(VRNDSCALESD, vrndscalesd,OpCls( XMM,      XMM_M64,   I8_U ), F_660F3A, 1,  no_WDS,0x0B,     0x00,     P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX)
insx(VRNDSCALESS, vrndscaless,OpCls( XMM,      XMM_M32,   I8_U ), F_660F3A, 1,  no_WDS,0x0A,     0x00,     P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX)

insx (VCVTTPD2UDQ, vcvttpd2udq,OpCls( XMM,     XMM_M128,  NONE ), F_0F,     1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)
insx (VCVTTPD2UQQ, vcvttpd2uqq,OpCls( XMM,     XMM_M128,  NONE ), F_660F,   1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,W1|QSIZE|FV,RWF_EVEX|RWF_VEX)

insx (VCVTTPS2UDQ, vcvttps2udq,OpCls( XMM,     XMM_M128,  NONE ), F_0F,     1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)
insx (VCVTTPS2UQQ, vcvttps2uqq,OpCls( XMM,     XMM_M128,  NONE ), F_660F,   1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,DSIZE|FV,RWF_EVEX|RWF_VEX)

insx (VCVTTSD2USI, vcvttsd2usi,OpCls( R32,     XMM_M64,  NONE ), F_F20F,    1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,W1|QSIZE|T1F64,RWF_EVEX|RWF_VEX)
insn (VCVTTSD2USI, 1,          OpCls( R64,     XMM_M64,  NONE ), F_F20F,    1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,W1|QSIZE|T1F64)

insx (VCVTTSS2USI, vcvttss2usi,OpCls( R32,     XMM_M32,  NONE ), F_F30F,    1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,DSIZE|T1F32,RWF_EVEX|RWF_VEX)
insn (VCVTTSS2USI, 1,          OpCls( R64,     XMM_M32,  NONE ), F_F30F,    1,  no_WDS, 0x78,    0x00,     P_686|P_AVX,DSIZE|T1F32)

insx(VPERMI2B, vpermi2b,               OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x75,     0x00,     P_686|P_AVX, BSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPERMI2W, vpermi2w,               OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x75,     0x00,     P_686|P_AVX, W1|WSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPERMI2D, vpermi2d,               OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x76,     0x00,     P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPERMI2Q, vpermi2q,               OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x76,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPERMI2PS, vpermi2ps,             OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x77,     0x00,     P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPERMI2PD, vpermi2pd,             OpCls( XMM,      XMM_M128,   NONE ), F_660F38,1,  no_WDS, 0x77,     0x00,     P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )

insx(VINSERTF128, vinsertf128,         OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x18,     0x00,     P_686|P_AVX, 0, RWF_VEX )
insx(VINSERTF32x4, vinsertf32x4,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x18,     0x00,     P_686|P_AVX, DSIZE|T4, RWF_EVEX|RWF_VEX )
insx(VINSERTF64x2, vinsertf64x2,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x18,     0x00,     P_686|P_AVX, W1|QSIZE|T2, RWF_EVEX|RWF_VEX )                                                        
insx(VINSERTF32x8, vinsertf32x8,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX, DSIZE|T8, RWF_EVEX|RWF_VEX )
insx(VINSERTF64x4, vinsertf64x4,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x1A,     0x00,     P_686|P_AVX, W1|QSIZE|T4, RWF_EVEX|RWF_VEX )
insx(VINSERTI128, vinserti128,         OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x38,     0x00,     P_686|P_AVX, 0, RWF_VEX )
insx(VINSERTI32x4, vinserti32x4,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x38,     0x00,     P_686|P_AVX, DSIZE|T4, RWF_EVEX|RWF_VEX )
insx(VINSERTI64x2, vinserti64x2,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x38,     0x00,     P_686|P_AVX, W1|QSIZE|T2, RWF_EVEX|RWF_VEX )
insx(VINSERTI32x8, vinserti32x8,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x3A,     0x00,     P_686|P_AVX, DSIZE|T8, RWF_EVEX|RWF_VEX )
insx(VINSERTI64x4, vinserti64x4,       OpCls( XMM,      XMM_M128,      I8_U ), F_660F3A,1,  no_WDS, 0x3A,     0x00,     P_686|P_AVX, W1|QSIZE|T4, RWF_EVEX|RWF_VEX )


insx(VMOVDQU8, vmovdqu8,     OpCls( XMM,      XMM_M128, NONE ), F_F20F, 1,  no_WDS, 0x6F,     0x00,       P_686|P_AVX,BSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQU8, 1,            OpCls( M128,     XMM,      NONE ), F_F20F, 0,  no_WDS, 0x7F,     0x00,       P_686|P_AVX,BSIZE|FVM)
insx(VMOVDQU16, vmovdqu16,   OpCls( XMM,      XMM_M128, NONE ), F_F20F, 1,  no_WDS, 0x6F,     0x00,       P_686|P_AVX,W1|WSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQU16, 1,           OpCls( M128,     XMM,      NONE ), F_F20F, 0,  no_WDS, 0x7F,     0x00,       P_686|P_AVX,W1|WSIZE|FVM)


insx(VMOVDQA32, vmovdqa32,    OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0x6F,     0x00,      P_686|P_AVX,DSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQA32, 1,            OpCls( M128,     XMM,      NONE ), F_660F, 0,  no_WDS, 0x7F,     0x00,      P_686|P_AVX,DSIZE|FVM)
insx(VMOVDQU32, vmovdqu32,    OpCls( XMM,      XMM_M128, NONE ), F_F30F, 1,  no_WDS, 0x6F,     0x00,      P_686|P_AVX,DSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQU32, 1,            OpCls( M128,     XMM,      NONE ), F_F30F, 0,  no_WDS, 0x7F,     0x00,      P_686|P_AVX,DSIZE|FVM)

insx(VMOVDQA64, vmovdqa64,    OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0x6F,     0x00,      P_686|P_AVX,W1|QSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQA64, 1,            OpCls( M128,     XMM,      NONE ), F_660F, 0,  no_WDS, 0x7F,     0x00,      P_686|P_AVX,W1|QSIZE|FVM)
insx(VMOVDQU64, vmovdqu64,    OpCls( XMM,      XMM_M128, NONE ), F_F30F, 1,  no_WDS, 0x6F,     0x00,      P_686|P_AVX,W1|QSIZE|FVM,RWF_EVEX|RWF_VEX)
insn(VMOVDQU64, 1,            OpCls( M128,     XMM,      NONE ), F_F30F, 0,  no_WDS, 0x7F,     0x00,      P_686|P_AVX,W1|QSIZE|FVM)
 
insx(VDBPSADBW, vdbpsadbw,    OpCls( XMM,      XMM_M128, I8_U ), F_660F3A, 1, no_WDS,0x42,     0x00,      P_686|P_AVX, DSIZE|FVM, RWF_EVEX|RWF_VEX )
insx(VFPCLASSPD, vfpclasspd,  OpCls( XMM,      XMM_M128, I8_U ), F_660F3A, 1, no_WDS,0x66,     0x00,      P_686|P_AVX,W1|QSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VFPCLASSPS, vfpclassps,  OpCls( XMM,      XMM_M128, I8_U ), F_660F3A, 1, no_WDS,0x66,     0x00,      P_686|P_AVX,DSIZE|FV, RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VFPCLASSSD, vfpclasssd,  OpCls( XMM,      XMM_M128, I8_U ), F_660F3A, 1, no_WDS,0x67,     0x00,      P_686|P_AVX,W1|QSIZE|T1S,RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VFPCLASSSS, vfpclassss,  OpCls( XMM,      XMM_M128, I8_U ), F_660F3A, 1, no_WDS,0x67,     0x00,      P_686|P_AVX,DSIZE|T1S,RWF_EVEX|RWF_VEX )                                                                                                                       
insx(VPCONFLICTD, vpconflictd,OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0xC4,     0x00,      P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPCONFLICTQ, vpconflictq,OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0xC4,     0x00,      P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPLZCNTD, vplzcntd,      OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0x44,     0x00,      P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPLZCNTQ, vplzcntq,      OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0x44,     0x00,      P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPMADD52LUQ, vpmadd52luq,OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0xB4,     0x00,      P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPMADD52HUQ, vpmadd52huq,OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0xB5,     0x00,      P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VPMOVM2B, vpmovm2b,      OpCls( XMM,      R8,       NONE ), F_F30F38, 1, no_WDS,0x28,     0x00,      P_686|P_AVX, BSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVM2W, vpmovm2w,      OpCls( XMM,      R16,      NONE ), F_F30F38, 1, no_WDS,0x28,     0x00,      P_686|P_AVX, W1|WSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVM2D, vpmovm2d,      OpCls( XMM,      R32,      NONE ), F_F30F38, 1, no_WDS,0x38,     0x00,      P_686|P_AVX, DSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVM2Q, vpmovm2q,      OpCls( XMM,      R64,      NONE ), F_F30F38, 1, no_WDS,0x38,     0x00,      P_686|P_AVX, W1|QSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVB2M, vpmovb2m,      OpCls(XMM,       XMM,      NONE ), F_F30F38, 1, no_WDS,0x29,     0x00,      P_686|P_AVX, BSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVW2M, vpmovw2m,      OpCls(XMM,       XMM,      NONE ), F_F30F38, 1, no_WDS,0x29,     0x00,      P_686|P_AVX, W1|WSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVD2M, vpmovd2m,      OpCls(XMM,       XMM,      NONE ), F_F30F38, 1, no_WDS,0x39,     0x00,      P_686|P_AVX, DSIZE,RWF_EVEX|RWF_VEX )
insx(VPMOVQ2M, vpmovq2m,      OpCls(XMM,       XMM,      NONE ), F_F30F38, 1, no_WDS,0x39,     0x00,      P_686|P_AVX, W1|QSIZE,RWF_EVEX|RWF_VEX )
insx(VPMULLQ,  vpmullq,       OpCls( XMM,      XMM_M128, NONE ), F_660F38, 1, no_WDS,0x40,     0x00,      P_686|P_AVX, W1|QSIZE|FV,RWF_EVEX|RWF_VEX )

insx(VRANGEPD, vrangepd,      OpCls( XMM,      XMM_M128, I8_U ), F_660F3A,1,  no_WDS, 0x50,    0x00,      P_686|P_AVX, W1|QSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VRANGEPS, vrangeps,      OpCls( XMM,      XMM_M128, I8_U ), F_660F3A,1,  no_WDS, 0x50,    0x00,      P_686|P_AVX, DSIZE|FV, RWF_EVEX|RWF_VEX )
insx(VRANGESD, vrangesd,      OpCls( XMM,      XMM_M128, I8_U ), F_660F3A,1,  no_WDS, 0x51,    0x00,      P_686|P_AVX, W1|QSIZE|T1S, RWF_EVEX|RWF_VEX )
insx(VRANGESS, vrangess,      OpCls( XMM,      XMM_M128, I8_U ), F_660F3A,1,  no_WDS, 0x51,    0x00,      P_686|P_AVX, DSIZE|T1S, RWF_EVEX|RWF_VEX )
