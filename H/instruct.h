...
insn(PADDUSW, 1,                OpCls( XMM,    XMM_M128_16,NONE ), F_660F, 1,  no_WDS, 0xDD,     0x00,       P_686|P_SSE2,QSIZE|FVM)
...
insx(VPCMPEQQ,    vpcmpeqq,       OpCls( XMM,     XMM_M128, NONE), F_660F38, 1,  no_WDS, 0x29,     0x00,       P_686|P_AVX,QSIZE|FV, RWF_VEX )
