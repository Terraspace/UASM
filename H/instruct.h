...
insn(PSLLW, 2,                  OpCls( XMM,      I8_U,     NONE ), F_660F, 0,  no_WDS, 0x71,     0x30,       P_686|P_SSE2,WSIZE|FVM)
insn(PSLLW, 3,                  OpCls( XMM,      XMM_M128, NONE ), F_660F, 1,  no_WDS, 0xF1,     0x00,       P_686|P_SSE2,WSIZE|T128)
...
insx(VBROADCASTSD, vbroadcastsd,       OpCls( YMM,      XMM_M64,    NONE ), F_660F38,1,  no_WDS, 0x19,     0x00,     P_686|P_AVX, W1|QSIZE|T1S, RWF_VEX )
