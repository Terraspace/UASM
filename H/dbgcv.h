/****************************************************************************
*
*  This code is Public Domain. It's new for HJWasm.
*
*  ========================================================================
*
...
enum cv4_leaf_indices {
    ...
    CV4_LF_POINTER   = 0x0002,  /* emitted by hjwasm */
    CV4_LF_ARRAY     = 0x0003,  /* emitted by hjwasm */
    CV4_LF_CLASS     = 0x0004,
    CV4_LF_STRUCTURE = 0x0005,  /* emitted by hjwasm */
    CV4_LF_UNION     = 0x0006,  /* emitted by hjwasm */
    CV4_LF_ENUM      = 0x0007,
    CV4_LF_PROCEDURE = 0x0008,  /* not yet emitted by hjwasm */
    //CV4_LF_MFUNCTION = 0x0009,
    //CV4_LF_VTSHAPE   = 0x000A,
    //CV4_LF_BARRAY    = 0x000D,

    CV4_LF_ARGLIST   = 0x0201,  /* not yet emitted by hjwasm */
    CV4_LF_FIELDLIST = 0x0204,  /* emitted by hjwasm */
    CV4_LF_BITFIELD  = 0x0206,  /* emitted by hjwasm */

    CV4_LF_MEMBER    = 0x0406,  /* emitted by hjwasm */
};
...
enum cv_leaf_indices {
    LF_MODIFIER  = 0x0001,
    LF_LABEL     = 0x000E,  /* emitted by hjwasm */
#if CV_SIGNATURE==CV4_SIGNATURE
